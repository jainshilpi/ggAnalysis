...
cmsswDir=/local/cms/user/wadud/aNTGCmet/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/
...
pset="/local/cms/user/wadud/aNTGCmet/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/run_condor_mc2017_106X.py"
