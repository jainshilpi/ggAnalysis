...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/xsecJobs//SinglePhoton/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/jobsMETv4/'


config.General.requestName = 'SinglePhoton'
