...
workarea='/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/crab_submit/jobsMETv4//SinglePhotonRun2017C31Mar2018v1MINIAOD/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ggNtuplizerMETv4/'


config.General.requestName = 'SinglePhotonRun2017C31Mar2018v1MINIAOD'
