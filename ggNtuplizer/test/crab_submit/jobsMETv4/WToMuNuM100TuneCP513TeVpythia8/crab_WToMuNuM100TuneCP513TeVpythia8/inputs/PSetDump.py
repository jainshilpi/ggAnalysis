...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/m/mwadud/private/naTGC/CMSSW_9_4_13/src/ggAnalysis/ggNtuplizer/test/ZNuNuGJets_MonoPhoton_PtG-130.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('anTGCtree_mc_numEvent100.root')
)
...
process.p = cms.Path(process.prefiringweight+process.ecalBadCalibReducedMINIAODFilter+process.fullPatMetSequenceModifiedMET+process.egammaPostRecoSeq+process.ggNtuplizer)
