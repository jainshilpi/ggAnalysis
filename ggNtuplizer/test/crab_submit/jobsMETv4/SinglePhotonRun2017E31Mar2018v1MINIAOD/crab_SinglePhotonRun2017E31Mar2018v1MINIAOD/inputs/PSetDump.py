...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Data2017sample.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('anTGCtree_data_numEvent200.root')
)
...
process.patCandidatesTask = cms.Task(process.makePatElectronsTask, process.makePatJetsTask, process.makePatMETsTask, process.makePatMuonsTask, process.makePatOOTPhotonsTask, process.makePatTausTask, process.patPhotons, process.pfParticleSelectionForIsoTask, process.pfPhotonIsolationPATTask)
