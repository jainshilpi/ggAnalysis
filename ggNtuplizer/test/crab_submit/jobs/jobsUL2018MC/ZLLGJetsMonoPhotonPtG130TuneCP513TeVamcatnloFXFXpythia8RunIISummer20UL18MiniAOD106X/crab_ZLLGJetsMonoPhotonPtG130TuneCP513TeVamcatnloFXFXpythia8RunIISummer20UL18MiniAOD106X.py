...
workarea='/afs/hep.wisc.edu/home/rusack/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018MC//ZLLGJetsMonoPhotonPtG130TuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL18MiniAOD106X/'

mainOutputDir = '/store/user/rusack/aNTGCmet/ntuples/jobsUL2018MC'

config                                = config()

config.General.requestName = 'ZLLGJetsMonoPhotonPtG130TuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL18MiniAOD106X'
...
config.Data.inputDataset = '/ZLLGJets_MonoPhoton_PtG-130_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v2/MINIAODSIM'
