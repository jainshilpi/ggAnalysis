...
workarea='/afs/hep.wisc.edu/home/rusack/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018MC//DYJetsToLLM50HT800to1200TuneCP5PSweights13TeVmadgraphMLMpythia8RunIISummer20UL18MiniAOD106X/'

mainOutputDir = '/store/user/rusack/aNTGCmet/ntuples/jobsUL2018MC'

config                                = config()

config.General.requestName = 'DYJetsToLLM50HT800to1200TuneCP5PSweights13TeVmadgraphMLMpythia8RunIISummer20UL18MiniAOD106X'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/rusack/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/run_mc2018_106X.py'
...
config.Data.inputDataset = '/DYJetsToLL_M-50_HT-800to1200_TuneCP5_PSweights_13TeV-madgraphMLM-pythia8/RunIISummer20UL18MiniAOD-106X_upgrade2018_realistic_v11_L1v1-v1/MINIAODSIM'
