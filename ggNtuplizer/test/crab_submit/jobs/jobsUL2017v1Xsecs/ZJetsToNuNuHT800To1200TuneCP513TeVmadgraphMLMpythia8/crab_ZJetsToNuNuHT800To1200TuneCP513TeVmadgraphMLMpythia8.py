...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1Xsecs//ZJetsToNuNuHT800To1200TuneCP513TeVmadgraphMLMpythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v1Xsecs'

config                                = config()

config.General.requestName = 'ZJetsToNuNuHT800To1200TuneCP513TeVmadgraphMLMpythia8'
