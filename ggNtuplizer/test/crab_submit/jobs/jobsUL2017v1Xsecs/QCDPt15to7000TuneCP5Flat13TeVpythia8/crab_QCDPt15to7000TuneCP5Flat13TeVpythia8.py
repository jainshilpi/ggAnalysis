...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1Xsecs//QCDPt15to7000TuneCP5Flat13TeVpythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v1Xsecs'

config                                = config()

config.General.requestName = 'QCDPt15to7000TuneCP5Flat13TeVpythia8'
