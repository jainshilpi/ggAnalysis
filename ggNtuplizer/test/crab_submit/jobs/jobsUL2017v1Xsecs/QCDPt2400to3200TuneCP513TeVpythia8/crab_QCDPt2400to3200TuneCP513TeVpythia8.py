...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1Xsecs//QCDPt2400to3200TuneCP513TeVpythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v1Xsecs'

config                                = config()

config.General.requestName = 'QCDPt2400to3200TuneCP513TeVpythia8'
