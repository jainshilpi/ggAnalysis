...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1Xsecs//WGToLNuG01J5fPtG300TuneCP513TeVamcatnloFXFXpythia8/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v1Xsecs'

config                                = config()

config.General.requestName = 'WGToLNuG01J5fPtG300TuneCP513TeVamcatnloFXFXpythia8'
