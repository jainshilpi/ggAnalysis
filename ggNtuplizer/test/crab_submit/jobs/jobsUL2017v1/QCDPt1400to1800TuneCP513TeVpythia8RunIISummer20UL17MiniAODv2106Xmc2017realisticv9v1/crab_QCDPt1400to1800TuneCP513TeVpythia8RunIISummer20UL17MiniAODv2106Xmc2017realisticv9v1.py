...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1//QCDPt1400to1800TuneCP513TeVpythia8RunIISummer20UL17MiniAODv2106Xmc2017realisticv9v1/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v1'

config                                = config()

config.General.requestName = 'QCDPt1400to1800TuneCP513TeVpythia8RunIISummer20UL17MiniAODv2106Xmc2017realisticv9v1'
