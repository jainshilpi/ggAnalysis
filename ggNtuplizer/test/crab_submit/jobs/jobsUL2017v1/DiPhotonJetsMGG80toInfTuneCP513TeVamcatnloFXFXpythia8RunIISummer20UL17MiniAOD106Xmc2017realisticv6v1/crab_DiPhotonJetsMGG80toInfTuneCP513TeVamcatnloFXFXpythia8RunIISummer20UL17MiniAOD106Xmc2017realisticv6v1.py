...
workarea='/afs/hep.wisc.edu/home/rusack/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1//DiPhotonJetsMGG80toInfTuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL17MiniAOD106Xmc2017realisticv6v1/'

mainOutputDir = '/store/user/rusack/aNTGCmet/ntuples/UL2017/jobsUL2017v1'

config                                = config()

config.General.requestName = 'DiPhotonJetsMGG80toInfTuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL17MiniAOD106Xmc2017realisticv6v1'
...
config.Data.inputDataset = '/DiPhotonJets_MGG-80toInf_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL17MiniAOD-106X_mc2017_realistic_v6-v1/MINIAODSIM'
