...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1//WJetsToLNuHT800To1200TuneCP513TeVmadgraphMLMpythia8RunIISummer20UL17MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v1'

config                                = config()

config.General.requestName = 'WJetsToLNuHT800To1200TuneCP513TeVmadgraphMLMpythia8RunIISummer20UL17MiniAOD106X'
