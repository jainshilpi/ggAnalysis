...
process.patMetModuleSequencePuppi = cms.Sequence(process.pfMetPuppi+process.ak4PFJetsPuppi+process.patJetCorrFactorsPuppi+process.patJetsPuppi+process.basicJetsForMetPuppi+process.jetSelectorForMetPuppi+process.cleanedPatJetsPuppi+process.metrawCaloPuppi+process.pfCHS+process.pfMetCHS+process.patCHSMet+process.pfTrk+process.pfMetTrk+process.patTrkMet+process.patPFMetPuppi)
...
process.patPFMetT1SmearPuppipatMetUncertaintySequencePuppi = cms.Sequence(process.pfElectronsPuppi+process.pfTausPuppi+process.pfMuonsPuppi+process.pfNoPileUpPuppi+process.pfPhotonsPuppi)
...
process.p = cms.Path(process.puppiMETSequence+process.fullPatMetSequencePuppi+process.fullPatMetSequenceModifiedPFMET+process.egammaPostRecoSeq+process.rerunMvaIsolationSequence+process.slimmedTausNewID+process.ecalBadCalibReducedMINIAODFilter+process.ggNtuplizer)
