...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1//WJetsToLNuHT800To1200TuneCP513TeVmadgraphMLMpythia8RunIISummer20UL17MiniAOD106Xmc2017realisticv6v1/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v1'

config                                = config()

config.General.requestName = 'WJetsToLNuHT800To1200TuneCP513TeVmadgraphMLMpythia8RunIISummer20UL17MiniAOD106Xmc2017realisticv6v1'
...
config.Data.inputDataset = '/WJetsToLNu_HT-800To1200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL17MiniAOD-106X_mc2017_realistic_v6-v1/MINIAODSIM'
