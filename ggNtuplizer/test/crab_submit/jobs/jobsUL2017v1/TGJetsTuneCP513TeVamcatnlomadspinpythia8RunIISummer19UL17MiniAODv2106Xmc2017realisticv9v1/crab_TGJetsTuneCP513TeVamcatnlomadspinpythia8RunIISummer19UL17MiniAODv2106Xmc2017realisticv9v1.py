...
workarea='/afs/hep.wisc.edu/home/rusack/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v1//TGJetsTuneCP513TeVamcatnlomadspinpythia8RunIISummer19UL17MiniAODv2106Xmc2017realisticv9v1/'

mainOutputDir = '/store/user/rusack/aNTGCmet/ntuples/UL2017/jobsUL2017v1'

config                                = config()

config.General.requestName = 'TGJetsTuneCP513TeVamcatnlomadspinpythia8RunIISummer19UL17MiniAODv2106Xmc2017realisticv9v1'
...
config.Data.inputDataset = '/TGJets_TuneCP5_13TeV-amcatnlo-madspin-pythia8/RunIISummer19UL17MiniAODv2-106X_mc2017_realistic_v9-v1/MINIAODSIM'
