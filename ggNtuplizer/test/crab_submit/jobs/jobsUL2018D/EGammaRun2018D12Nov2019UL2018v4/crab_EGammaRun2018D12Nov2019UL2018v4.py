...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018D//EGammaRun2018D12Nov2019UL2018v4/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2018D/jobsUL2018D'

config                                = config()

config.General.requestName = 'EGammaRun2018D12Nov2019UL2018v4'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/run_data2018D_106X.py'
