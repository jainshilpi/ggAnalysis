...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/hdfs/store/user/rusack/aNTGCmet/test/UL18TestMC_MINIAOD.root')
)
...
process.AK4PFCHSupdatedpileupJetIdCalculator = cms.EDProducer("PileupJetIdProducer",
    ...
    jetids = cms.InputTag(""),
    jets = cms.InputTag("ak4PFJetsCHSupdated"),
...
process.AK4PFCHSupdatedpileupJetIdEvaluator = cms.EDProducer("PileupJetIdProducer",
    algos = cms.VPSet(
        cms.PSet(
            JetIdParams = cms.PSet(
    ...
    inputIsCorrected = cms.bool(False),
    jec = cms.string('AK4PFchs'),
    jetids = cms.InputTag("AK4PFCHSupdatedpileupJetIdCalculator"),
    jets = cms.InputTag("ak4PFJetsCHSupdated"),
...
process.QGTaggerAK4PFCHSupdated = cms.EDProducer("QGTagger",
    jetsLabel = cms.string('QGL_AK4PFchs'),
    srcJets = cms.InputTag("ak4PFJetsCHSupdated"),
    srcRho = cms.InputTag("fixedGridRhoFastjetAll"),
    srcVertexCollection = cms.InputTag("offlinePrimaryVerticesWithBS"),
    useQualityCuts = cms.bool(False)
)
...
process.ak4CaloL2L3CorrectorModifiedPFMET = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4CaloL2RelativeCorrectorModifiedPFMET"), cms.InputTag("ak4CaloL3AbsoluteCorrectorModifiedPFMET"))
)


process.ak4CaloL2L3CorrectorPuppiUpdated = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4CaloL2RelativeCorrectorPuppiUpdated"), cms.InputTag("ak4CaloL3AbsoluteCorrectorPuppiUpdated"))
)
...
process.ak4CaloL2L3ResidualCorrectorModifiedPFMET = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4CaloL2RelativeCorrectorModifiedPFMET"), cms.InputTag("ak4CaloL3AbsoluteCorrectorModifiedPFMET"), cms.InputTag("ak4CaloResidualCorrectorModifiedPFMET"))
)


process.ak4CaloL2L3ResidualCorrectorPuppiUpdated = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4CaloL2RelativeCorrectorPuppiUpdated"), cms.InputTag("ak4CaloL3AbsoluteCorrectorPuppiUpdated"), cms.InputTag("ak4CaloResidualCorrectorPuppiUpdated"))
)
...
process.ak4CaloL2RelativeCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L2Relative')
)


process.ak4CaloL2RelativeCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L2Relative')
)
...
process.ak4CaloL3AbsoluteCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L3Absolute')
)


process.ak4CaloL3AbsoluteCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L3Absolute')
)
...
process.ak4CaloResidualCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L2L3Residual')
)


process.ak4CaloResidualCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK5Calo'),
    level = cms.string('L2L3Residual')
)
...
process.ak4PFCHSL1FastL2L3CorrectorModifiedPFMET = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4PFCHSL1FastjetCorrectorModifiedPFMET"), cms.InputTag("ak4PFCHSL2RelativeCorrectorModifiedPFMET"), cms.InputTag("ak4PFCHSL3AbsoluteCorrectorModifiedPFMET"))
)


process.ak4PFCHSL1FastL2L3CorrectorPuppiUpdated = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4PFCHSL1FastjetCorrectorPuppiUpdated"), cms.InputTag("ak4PFCHSL2RelativeCorrectorPuppiUpdated"), cms.InputTag("ak4PFCHSL3AbsoluteCorrectorPuppiUpdated"))
)
...
process.ak4PFCHSL1FastL2L3ResidualCorrectorModifiedPFMET = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4PFCHSL1FastjetCorrectorModifiedPFMET"), cms.InputTag("ak4PFCHSL2RelativeCorrectorModifiedPFMET"), cms.InputTag("ak4PFCHSL3AbsoluteCorrectorModifiedPFMET"), cms.InputTag("ak4PFCHSResidualCorrectorModifiedPFMET"))
)


process.ak4PFCHSL1FastL2L3ResidualCorrectorPuppiUpdated = cms.EDProducer("ChainedJetCorrectorProducer",
    correctors = cms.VInputTag(cms.InputTag("ak4PFCHSL1FastjetCorrectorPuppiUpdated"), cms.InputTag("ak4PFCHSL2RelativeCorrectorPuppiUpdated"), cms.InputTag("ak4PFCHSL3AbsoluteCorrectorPuppiUpdated"), cms.InputTag("ak4PFCHSResidualCorrectorPuppiUpdated"))
)
...
process.ak4PFCHSL1FastjetCorrectorModifiedPFMET = cms.EDProducer("L1FastjetCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L1FastJet'),
    srcRho = cms.InputTag("fixedGridRhoFastjetAll")
)
...
process.ak4PFCHSL1FastjetCorrectorPuppiUpdated = cms.EDProducer("L1FastjetCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L1FastJet'),
    srcRho = cms.InputTag("fixedGridRhoFastjetAll")
)
...
process.ak4PFCHSL2RelativeCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L2Relative')
)


process.ak4PFCHSL2RelativeCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L2Relative')
)
...
process.ak4PFCHSL3AbsoluteCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L3Absolute')
)


process.ak4PFCHSL3AbsoluteCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L3Absolute')
)
...
process.ak4PFCHSResidualCorrectorModifiedPFMET = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L2L3Residual')
)


process.ak4PFCHSResidualCorrectorPuppiUpdated = cms.EDProducer("LXXXCorrectorProducer",
    algorithm = cms.string('AK4PFchs'),
    level = cms.string('L2L3Residual')
)


process.ak4PFJetsCHSModifiedPFMET = cms.EDProducer("FastjetJetProducer",
    ...
    minSeed = cms.uint32(14327),
    rParam = cms.double(0.4),
    src = cms.InputTag("pfNoPileUpJMEModifiedPFMET"),
    srcPVs = cms.InputTag(""),
    useDeterministicSeed = cms.bool(True),
...
process.ak4PFJetsCHSupdated = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.ak4PFJetsCHSupdatedConstituents = cms.EDProducer("MiniAODJetConstituentSelector",
    cut = cms.string(''),
    src = cms.InputTag("ak4PFJetsCHSupdated")
)


process.ak4PFJetsPuppiUpdated = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.ak4PFJetsPuppiupdatedConstituents = cms.EDProducer("MiniAODJetConstituentSelector",
    cut = cms.string(''),
    src = cms.InputTag("ak4PFJetsPuppiupdated")
)
...
process.basicJetsForMetModifiedPFMET = cms.EDProducer("PATJetCleanerForType1MET",
    ...
    src = cms.InputTag("patJetsModifiedPFMET"),
    type1JetPtThreshold = cms.double(15.0)
)


process.basicJetsForMetPuppiUpdated = cms.EDProducer("PATJetCleanerForType1MET",
    jetCorrEtaMax = cms.double(9.9),
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("patJetsPuppiUpdated"),
    type1JetPtThreshold = cms.double(15.0)
)
...
process.caloMetT1ModifiedPFMET = cms.EDProducer("CorrectedCaloMETProducer",
    src = cms.InputTag("caloMetM"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrCaloMetType1ModifiedPFMET","type1"))
)


process.caloMetT1PuppiUpdated = cms.EDProducer("CorrectedCaloMETProducer",
    src = cms.InputTag("caloMetM"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrCaloMetType1PuppiUpdated","type1"))
)
...
process.caloMetT1T2ModifiedPFMET = cms.EDProducer("CorrectedCaloMETProducer",
    src = cms.InputTag("caloMetM"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrCaloMetType1ModifiedPFMET","type1"), cms.InputTag("corrCaloMetType2ModifiedPFMET"))
)


process.caloMetT1T2PuppiUpdated = cms.EDProducer("CorrectedCaloMETProducer",
    src = cms.InputTag("caloMetM"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrCaloMetType1PuppiUpdated","type1"), cms.InputTag("corrCaloMetType2PuppiUpdated"))
)


process.cleanedPatJetsModifiedPFMET = cms.EDProducer("PATJetCleaner",
    ...
    finalCut = cms.string(''),
    preselection = cms.string(''),
    src = cms.InputTag("jetSelectorForMetModifiedPFMET")
)


process.cleanedPatJetsPuppiUpdated = cms.EDProducer("PATJetCleaner",
    checkOverlaps = cms.PSet(
        electrons = cms.PSet(
            algorithm = cms.string('byDeltaR'),
            checkRecoComponents = cms.bool(False),
    ...
    finalCut = cms.string(''),
    preselection = cms.string(''),
    src = cms.InputTag("jetSelectorForMetPuppiUpdated")
)
...
process.corrCaloMetType1ModifiedPFMET = cms.EDProducer("CaloJetMETcorrInputProducer",
    jetCorrEtaMax = cms.double(9.9),
    jetCorrLabel = cms.InputTag("ak4CaloL2L3CorrectorModifiedPFMET"),
    skipEM = cms.bool(True),
    skipEMfractionThreshold = cms.double(0.9),
    src = cms.InputTag("ak4CaloJets"),
    srcMET = cms.InputTag("caloMetM"),
...
process.corrCaloMetType1PuppiUpdated = cms.EDProducer("CaloJetMETcorrInputProducer",
    jetCorrEtaMax = cms.double(9.9),
    jetCorrLabel = cms.InputTag("ak4CaloL2L3CorrectorPuppiUpdated"),
    skipEM = cms.bool(True),
    skipEMfractionThreshold = cms.double(0.9),
    src = cms.InputTag("ak4CaloJets"),
    srcMET = cms.InputTag("caloMetM"),
...
process.corrCaloMetType2ModifiedPFMET = cms.EDProducer("Type2CorrectionProducer",
    srcUnclEnergySums = cms.VInputTag(cms.InputTag("corrCaloMetType1ModifiedPFMET","type2"), cms.InputTag("muCaloMetCorrModifiedPFMET")),
    type2CorrFormula = cms.string('A + B*TMath::Exp(-C*x)'),
    type2CorrParameter = cms.PSet(
        A = cms.double(2.0),
        B = cms.double(1.3),
...
process.corrCaloMetType2PuppiUpdated = cms.EDProducer("Type2CorrectionProducer",
    srcUnclEnergySums = cms.VInputTag(cms.InputTag("corrCaloMetType1PuppiUpdated","type2"), cms.InputTag("muCaloMetCorrPuppiUpdated")),
    type2CorrFormula = cms.string('A + B*TMath::Exp(-C*x)'),
    type2CorrParameter = cms.PSet(
        A = cms.double(2.0),
        B = cms.double(1.3),
...
process.corrPfMetType1ModifiedPFMET = cms.EDProducer("PFJetMETcorrInputProducer",
    jetCorrEtaMax = cms.double(9.9),
    jetCorrLabel = cms.InputTag("ak4PFCHSL1FastL2L3CorrectorModifiedPFMET"),
    jetCorrLabelRes = cms.InputTag("ak4PFCHSL1FastL2L3ResidualCorrectorModifiedPFMET"),
    offsetCorrLabel = cms.InputTag("ak4PFCHSL1FastjetCorrectorModifiedPFMET"),
    skipEM = cms.bool(True),
    skipEMfractionThreshold = cms.double(0.9),
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("ak4PFJetsCHSModifiedPFMET"),
    type1JetPtThreshold = cms.double(15.0)
)


process.corrPfMetType1PuppiUpdated = cms.EDProducer("PFJetMETcorrInputProducer",
    jetCorrEtaMax = cms.double(9.9),
...
process.corrPfMetType2ModifiedPFMET = cms.EDProducer("Type2CorrectionProducer",
    srcUnclEnergySums = cms.VInputTag(cms.InputTag("corrPfMetType1ModifiedPFMET","type2"), cms.InputTag("corrPfMetType1ModifiedPFMET","offset"), cms.InputTag("pfCandMETcorrModifiedPFMET")),
    type2CorrFormula = cms.string('A'),
    type2CorrParameter = cms.PSet(
        A = cms.double(1.4)
    )
...
process.corrPfMetType2PuppiUpdated = cms.EDProducer("Type2CorrectionProducer",
    srcUnclEnergySums = cms.VInputTag(cms.InputTag("corrPfMetType1PuppiUpdated","type2"), cms.InputTag("corrPfMetType1PuppiUpdated","offset"), cms.InputTag("pfCandMETcorrPuppiUpdated")),
    type2CorrFormula = cms.string('A'),
    type2CorrParameter = cms.PSet(
        A = cms.double(1.4)
    )
...
process.deepTau2017v1 = cms.EDProducer("DeepTauId",
    VSeWP = cms.PSet(
        Loose = cms.string('0.99831'),
        Medium = cms.string('0.99868'),
        Tight = cms.string('0.99898'),
        VLoose = cms.string('0.99574'),
        VTight = cms.string('0.99911'),
        VVLoose = cms.string('0.98992'),
        VVTight = cms.string('0.99918'),
        VVVLoose = cms.string('0.96424')
    ),
    VSjetWP = cms.PSet(
        Loose = cms.string('0.914'),
        Medium = cms.string('0.9464'),
        Tight = cms.string('0.9635'),
        VLoose = cms.string('0.8623'),
        VTight = cms.string('0.976'),
        VVLoose = cms.string('0.7645'),
        VVTight = cms.string('0.9859'),
        VVVLoose = cms.string('0.5329')
    ),
    VSmuWP = cms.PSet(
        Loose = cms.string('0.999755'),
        Medium = cms.string('0.999854'),
        Tight = cms.string('0.999886'),
        VLoose = cms.string('0.999392'),
        VTight = cms.string('0.999944'),
        VVLoose = cms.string('0.997687'),
        VVTight = cms.string('0.9999971'),
        VVVLoose = cms.string('0.959619')
    ),
    debug_level = cms.int32(0),
    disable_dxy_pca = cms.bool(False),
    electrons = cms.InputTag("slimmedElectrons"),
    graph_file = cms.vstring('RecoTauTag/TrainingFiles/data/DeepTauId/deepTau_2017v1_20L1024N_quantized.pb'),
...
process.genMetExtractorModifiedPFMET = cms.EDProducer("GenMETExtractor",
    metSource = cms.InputTag("slimmedMETs","","@skipCurrentProcess")
)


process.genMetExtractorPuppiUpdated = cms.EDProducer("GenMETExtractor",
    metSource = cms.InputTag("slimmedMETs","","@skipCurrentProcess")
)
...
process.metrawCaloModifiedPFMET = cms.EDProducer("RecoMETExtractor",
    correctionLevel = cms.string('rawCalo'),
    metSource = cms.InputTag("slimmedMETs","","@skipCurrentProcess")
)


process.metrawCaloPuppiUpdated = cms.EDProducer("RecoMETExtractor",
    correctionLevel = cms.string('rawCalo'),
...
process.muCaloMetCorrModifiedPFMET = cms.EDProducer("MuonMETcorrInputProducer",
    src = cms.InputTag("muons"),
    srcMuonCorrections = cms.InputTag("muonMETValueMapProducer","muCorrData")
)


process.muCaloMetCorrPuppiUpdated = cms.EDProducer("MuonMETcorrInputProducer",
    src = cms.InputTag("muons"),
    srcMuonCorrections = cms.InputTag("muonMETValueMapProducer","muCorrData")
)
...
process.particleFlowPtrsModifiedPFMET = cms.EDProducer("PFCandidateFwdPtrProducer",
    src = cms.InputTag("particleFlow")
)


process.particleFlowPtrsPuppiUpdated = cms.EDProducer("PFCandidateFwdPtrProducer",
    src = cms.InputTag("particleFlow")
)
...
process.patCaloMet = cms.EDProducer("PATMETProducer",
    ...
    genMETSource = cms.InputTag("genMetTrue"),
    metSource = cms.InputTag("metrawCaloPuppiUpdated"),
    muonSource = cms.InputTag("muons"),
    parameters = cms.PSet(
        dRMatch = cms.double(0.4),
        jetThreshold = cms.double(15),
...
process.patJetCorrFactorsAK4PFPuppiupdated = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetCorrFactorsModifiedPFMET = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetCorrFactorsPuppiUpdated = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetFlavourAssociationAK4PFCHSupdated = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsupdated","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsupdated","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFJetsCHSupdated"),
    leptons = cms.InputTag("patJetPartonsupdated","leptons"),
    partons = cms.InputTag("patJetPartonsupdated","physicsPartons"),
    rParam = cms.double(0.4)
)


process.patJetFlavourAssociationAK4PFPuppiupdated = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsupdated","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsupdated","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFJetsPuppiupdated"),
    leptons = cms.InputTag("patJetPartonsupdated","leptons"),
    partons = cms.InputTag("patJetPartonsupdated","physicsPartons"),
    rParam = cms.double(0.4)
)
...
process.patJetFlavourAssociationLegacyAK4PFCHSupdated = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAK4PFCHSupdated")
)


process.patJetFlavourAssociationLegacyAK4PFPuppiupdated = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAK4PFPuppiupdated")
)


process.patJetFlavourAssociationLegacyModifiedPFMET = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyModifiedPFMET")
)


process.patJetFlavourAssociationLegacyPuppiUpdated = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyPuppiUpdated")
)


process.patJetFlavourAssociationModifiedPFMET = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsModifiedPFMET","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsModifiedPFMET","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFJetsCHSModifiedPFMET"),
    leptons = cms.InputTag("patJetPartonsModifiedPFMET","leptons"),
    partons = cms.InputTag("patJetPartonsModifiedPFMET","physicsPartons"),
    rParam = cms.double(0.4)
)


process.patJetFlavourAssociationPuppiUpdated = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsPuppiUpdated","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsPuppiUpdated","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFJetsPuppiUpdated"),
    leptons = cms.InputTag("patJetPartonsPuppiUpdated","leptons"),
    partons = cms.InputTag("patJetPartonsPuppiUpdated","physicsPartons"),
    rParam = cms.double(0.4)
)
...
process.patJetGenJetMatchAK4PFCHSupdated = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
...
process.patJetGenJetMatchAK4PFPuppiupdated = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenJetsNoNu"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetGenJetMatchModifiedPFMET = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenJets"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetGenJetMatchPuppiUpdated = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak4GenJets"),
    maxDeltaR = cms.double(0.4),
    mcPdgId = cms.vint32(),
...
process.patJetPartonAssociationLegacyAK4PFCHSupdated = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFJetsCHSupdated"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyAK4PFPuppiupdated = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFJetsPuppiupdated"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyModifiedPFMET = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFJetsCHSModifiedPFMET"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyPuppiUpdated = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak4PFJetsPuppiUpdated"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonMatchAK4PFCHSupdated = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
...
process.patJetPartonMatchAK4PFPuppiupdated = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonMatchModifiedPFMET = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonMatchPuppiUpdated = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("genParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonsLegacyModifiedPFMET = cms.EDProducer("PartonSelector",
    src = cms.InputTag("genParticles"),
    withLeptons = cms.bool(False)
)


process.patJetPartonsLegacyPuppiUpdated = cms.EDProducer("PartonSelector",
    src = cms.InputTag("genParticles"),
    withLeptons = cms.bool(False)
)


process.patJetPartonsLegacyupdated = cms.EDProducer("PartonSelector",
    src = cms.InputTag("prunedGenParticles"),
    withLeptons = cms.bool(False)
)


process.patJetPartonsModifiedPFMET = cms.EDProducer("HadronAndPartonSelector",
    fullChainPhysPartons = cms.bool(True),
...
process.patJetPartonsPuppiUpdated = cms.EDProducer("HadronAndPartonSelector",
    fullChainPhysPartons = cms.bool(True),
    particles = cms.InputTag("genParticles"),
    partonMode = cms.string('Auto'),
    src = cms.InputTag("generator")
...
process.patJetPartonsupdated = cms.EDProducer("HadronAndPartonSelector",
    fullChainPhysPartons = cms.bool(True),
    particles = cms.InputTag("prunedGenParticles"),
    partonMode = cms.string('Auto'),
    src = cms.InputTag("generator")
...
process.patJetsAK4PFCHSupdated = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAK4PFCHSupdated"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAK4PFCHSupdated"),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAK4PFCHSupdated"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK4PFCHSupdated"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK4PFCHSupdated")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak4PFJetsCHSupdated"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
    ...
    userData = cms.PSet(
        ...
        userFloats = cms.PSet(
            src = cms.VInputTag("", "QGTaggerAK4PFCHSupdated:qgLikelihood", "AK4PFCHSupdatedpileupJetIdEvaluator:fullDiscriminant")
        ),
        userFunctionLabels = cms.vstring(),
        userFunctions = cms.vstring(),
        userInts = cms.PSet(
            src = cms.VInputTag("", "AK4PFCHSupdatedpileupJetIdEvaluator:cutbasedId", "AK4PFCHSupdatedpileupJetIdEvaluator:fullId")
        )
    )
)


process.patJetsAK4PFCHSupdatedPATJetswithUserData = cms.EDProducer("PATJetUserDataEmbedder",
    src = cms.InputTag("patJetsAK4PFCHSupdated"),
    userFloats = cms.PSet(

    ),
    userInts = cms.PSet(
        looseId = cms.InputTag("patJetsAK4PFCHSupdatedlooseJetId"),
        tightId = cms.InputTag("patJetsAK4PFCHSupdatedtightJetId"),
        tightIdLepVeto = cms.InputTag("patJetsAK4PFCHSupdatedtightJetIdLepVeto")
    )
)


process.patJetsAK4PFCHSupdatedlooseJetId = cms.EDProducer("PatJetIDValueMapProducer",
...
process.patJetsAK4PFCHSupdatedtightJetId = cms.EDProducer("PatJetIDValueMapProducer",
    filterParams = cms.PSet(
...
process.patJetsAK4PFCHSupdatedtightJetIdLepVeto = cms.EDProducer("PatJetIDValueMapProducer",
    filterParams = cms.PSet(
...
process.patJetsAK4PFPuppiupdated = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAK4PFPuppiupdated"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAK4PFPuppiupdated"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addEfficiencies = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAK4PFPuppiupdated"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK4PFPuppiupdated"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK4PFPuppiupdated")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak4PFJetsPuppiupdated"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.patJetsAK4PFPuppiupdatedPATJetswithUserData = cms.EDProducer("PATJetUserDataEmbedder",
    src = cms.InputTag("patJetsAK4PFPuppiupdated"),
    userFloats = cms.PSet(

    ),
    userInts = cms.PSet(
        looseId = cms.InputTag("patJetsAK4PFPuppiupdatedlooseJetId"),
        tightId = cms.InputTag("patJetsAK4PFPuppiupdatedtightJetId"),
        tightIdLepVeto = cms.InputTag("patJetsAK4PFPuppiupdatedtightJetIdLepVeto")
    )
)


process.patJetsAK4PFPuppiupdatedlooseJetId = cms.EDProducer("PatJetIDValueMapProducer",
    filterParams = cms.PSet(
        quality = cms.string('LOOSE'),
        version = cms.string('WINTER16')
    ),
...
process.patJetsAK4PFPuppiupdatedtightJetId = cms.EDProducer("PatJetIDValueMapProducer",
    filterParams = cms.PSet(
        quality = cms.string('TIGHT'),
        version = cms.string('SUMMER18')
    ),
...
process.patJetsAK4PFPuppiupdatedtightJetIdLepVeto = cms.EDProducer("PatJetIDValueMapProducer",
    filterParams = cms.PSet(
        quality = cms.string('TIGHTLEPVETO'),
        version = cms.string('SUMMER18')
    ),
...
process.patJetsModifiedPFMET = cms.EDProducer("PATJetProducer",
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addEfficiencies = cms.bool(False),
    ...
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsModifiedPFMET")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak4PFJetsCHSModifiedPFMET"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.patJetsPuppiUpdated = cms.EDProducer("PATJetProducer",
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addEfficiencies = cms.bool(False),
    ...
    getJetMCFlavour = cms.bool(False),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsPuppiUpdated")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak4PFJetsPuppiUpdated"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
...
process.patPFMetModifiedPFMET = cms.EDProducer("PATMETProducer",
    addEfficiencies = cms.bool(False),
    addGenMET = cms.bool(True),
    addMuonCorrections = cms.bool(False),
    addResolutions = cms.bool(False),
    ...
    genMETSource = cms.InputTag("genMetExtractorModifiedPFMET"),
    metSource = cms.InputTag("pfMetModifiedPFMET"),
    muonSource = cms.InputTag("muons"),
    parameters = cms.PSet(
        dRMatch = cms.double(0.4),
        jetThreshold = cms.double(15),
    ...
    srcJetResPt = cms.string('AK4PFchs_pt'),
    srcJetSF = cms.string('AK4PFchs'),
    srcJets = cms.InputTag("cleanedPatJetsModifiedPFMET"),
...
process.patPFMetPuppiUpdated = cms.EDProducer("PATMETProducer",
    addEfficiencies = cms.bool(False),
    addGenMET = cms.bool(True),
    addMuonCorrections = cms.bool(False),
    addResolutions = cms.bool(False),
    ...
    genMETSource = cms.InputTag("genMetExtractorPuppiUpdated"),
    metSource = cms.InputTag("pfMetPuppiUpdated"),
    muonSource = cms.InputTag("muons"),
    parameters = cms.PSet(
        dRMatch = cms.double(0.4),
        jetThreshold = cms.double(15),
    ...
    srcJets = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    srcLeptons = cms.VInputTag(cms.InputTag("slimmedElectrons"), cms.InputTag("slimmedMuons"), cms.InputTag("slimmedPhotons")),
...
process.patPFMetT0CorrModifiedPFMET = cms.EDProducer("Type0PFMETcorrInputProducer",
    correction = cms.PSet(
        formula = cms.string('(x<35)?(-( [0]+x*[1]+pow(x, 2)*[2]+pow(x, 3)*[3] )):(-( [0]+35*[1]+pow(35, 2)*[2]+pow(35, 3)*[3] ))'),
        par0 = cms.double(-0.181414),
        par1 = cms.double(-0.476934),
    ...
    minDz = cms.double(0.2),
    srcHardScatterVertex = cms.InputTag("selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET"),
    srcPFCandidateToVertexAssociations = cms.InputTag("pfCandidateToVertexAssociation")
)


process.patPFMetT0CorrPuppiUpdated = cms.EDProducer("Type0PFMETcorrInputProducer",
    correction = cms.PSet(
        formula = cms.string('(x<35)?(-( [0]+x*[1]+pow(x, 2)*[2]+pow(x, 3)*[3] )):(-( [0]+35*[1]+pow(35, 2)*[2]+pow(35, 3)*[3] ))'),
        par0 = cms.double(-0.181414),
        par1 = cms.double(-0.476934),
    ...
    minDz = cms.double(0.2),
    srcHardScatterVertex = cms.InputTag("selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0PuppiUpdated"),
    srcPFCandidateToVertexAssociations = cms.InputTag("pfCandidateToVertexAssociation")
)
...
process.patPFMetT0pcT1ModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrModifiedPFMET","type1"), cms.InputTag("patPFMetT0CorrModifiedPFMET"))
)


process.patPFMetT0pcT1PuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrPuppiUpdated","type1"), cms.InputTag("patPFMetT0CorrPuppiUpdated"))
)
...
process.patPFMetT0pcT1T2ModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrModifiedPFMET","type1"), cms.InputTag("patPFMetT2CorrModifiedPFMET","type2"), cms.InputTag("patPFMetT0CorrModifiedPFMET"))
)


process.patPFMetT0pcT1T2PuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrPuppiUpdated","type1"), cms.InputTag("patPFMetT2CorrPuppiUpdated","type2"), cms.InputTag("patPFMetT0CorrPuppiUpdated"))
)
...
process.patPFMetT1ElectronEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnDownModifiedPFMET"))
)


process.patPFMetT1ElectronEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnDownPuppiUpdated"))
)


process.patPFMetT1ElectronEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnUpModifiedPFMET"))
)


process.patPFMetT1ElectronEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnUpPuppiUpdated"))
)


process.patPFMetT1JetEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnDownModifiedPFMET"))
)


process.patPFMetT1JetEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnDownPuppiUpdated"))
)


process.patPFMetT1JetEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnUpModifiedPFMET"))
)


process.patPFMetT1JetEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnUpPuppiUpdated"))
)


process.patPFMetT1JetResDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetResDownModifiedPFMET"))
)


process.patPFMetT1JetResDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetResDownPuppiUpdated"))
)


process.patPFMetT1JetResUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetResUpModifiedPFMET"))
)


process.patPFMetT1JetResUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetResUpPuppiUpdated"))
)


process.patPFMetT1ModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrModifiedPFMET","type1"))
)


process.patPFMetT1MuonEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnDownModifiedPFMET"))
)


process.patPFMetT1MuonEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnDownPuppiUpdated"))
)


process.patPFMetT1MuonEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnUpModifiedPFMET"))
)


process.patPFMetT1MuonEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnUpPuppiUpdated"))
)


process.patPFMetT1PhotonEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnDownModifiedPFMET"))
)


process.patPFMetT1PhotonEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnDownPuppiUpdated"))
)


process.patPFMetT1PhotonEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnUpModifiedPFMET"))
)


process.patPFMetT1PhotonEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnUpPuppiUpdated"))
)


process.patPFMetT1PuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrPuppiUpdated","type1"))
)
...
process.patPFMetT1SmearElectronEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnDownModifiedPFMET"))
)


process.patPFMetT1SmearElectronEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnDownPuppiUpdated"))
)


process.patPFMetT1SmearElectronEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnUpModifiedPFMET"))
)


process.patPFMetT1SmearElectronEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrElectronEnUpPuppiUpdated"))
)


process.patPFMetT1SmearJetEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnDownModifiedPFMET"))
)


process.patPFMetT1SmearJetEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnDownPuppiUpdated"))
)


process.patPFMetT1SmearJetEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnUpModifiedPFMET"))
)


process.patPFMetT1SmearJetEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrJetEnUpPuppiUpdated"))
)


process.patPFMetT1SmearJetResDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrSmearedJetResDownModifiedPFMET"))
)


process.patPFMetT1SmearJetResDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrSmearedJetResDownPuppiUpdated"))
)


process.patPFMetT1SmearJetResUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrSmearedJetResUpModifiedPFMET"))
)


process.patPFMetT1SmearJetResUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrSmearedJetResUpPuppiUpdated"))
)


process.patPFMetT1SmearModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2SmearCorrModifiedPFMET","type1"))
)


process.patPFMetT1SmearMuonEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnDownModifiedPFMET"))
)


process.patPFMetT1SmearMuonEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnDownPuppiUpdated"))
)


process.patPFMetT1SmearMuonEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnUpModifiedPFMET"))
)


process.patPFMetT1SmearMuonEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrMuonEnUpPuppiUpdated"))
)


process.patPFMetT1SmearPhotonEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnDownModifiedPFMET"))
)


process.patPFMetT1SmearPhotonEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnDownPuppiUpdated"))
)


process.patPFMetT1SmearPhotonEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnUpModifiedPFMET"))
)


process.patPFMetT1SmearPhotonEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrPhotonEnUpPuppiUpdated"))
)


process.patPFMetT1SmearPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2SmearCorrPuppiUpdated","type1"))
)


process.patPFMetT1SmearTauEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnDownModifiedPFMET"))
)


process.patPFMetT1SmearTauEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnDownPuppiUpdated"))
)


process.patPFMetT1SmearTauEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnUpModifiedPFMET"))
)


process.patPFMetT1SmearTauEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnUpPuppiUpdated"))
)


process.patPFMetT1SmearUnclusteredEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnDownModifiedPFMET"))
)


process.patPFMetT1SmearUnclusteredEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnDownPuppiUpdated"))
)


process.patPFMetT1SmearUnclusteredEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnUpModifiedPFMET"))
)


process.patPFMetT1SmearUnclusteredEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1SmearPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnUpPuppiUpdated"))
)
...
process.patPFMetT1T2CorrModifiedPFMET = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    skipEM = cms.bool(True),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("cleanedPatJetsModifiedPFMET"),
    type1JetPtThreshold = cms.double(15.0)
)


process.patPFMetT1T2CorrPuppiUpdated = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    type1JetPtThreshold = cms.double(15.0)
)


process.patPFMetT1T2ModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrModifiedPFMET","type1"), cms.InputTag("patPFMetT2CorrModifiedPFMET","type2"))
)


process.patPFMetT1T2PuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrPuppiUpdated","type1"), cms.InputTag("patPFMetT2CorrPuppiUpdated","type2"))
)
...
process.patPFMetT1T2SmearCorrModifiedPFMET = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    skipEM = cms.bool(True),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrModifiedPFMET"),
    type1JetPtThreshold = cms.double(15.0)
)


process.patPFMetT1T2SmearCorrPuppiUpdated = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag(""),
    skipEM = cms.bool(True),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrPuppiUpdated"),
    type1JetPtThreshold = cms.double(15.0)
)
...
process.patPFMetT1TauEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnDownModifiedPFMET"))
)


process.patPFMetT1TauEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnDownPuppiUpdated"))
)


process.patPFMetT1TauEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnUpModifiedPFMET"))
)


process.patPFMetT1TauEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrTauEnUpPuppiUpdated"))
)
...
process.patPFMetT1TxyModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrModifiedPFMET","type1"), cms.InputTag("patPFMetTxyCorrModifiedPFMET"))
)


process.patPFMetT1TxyPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetT1T2CorrPuppiUpdated","type1"), cms.InputTag("patPFMetTxyCorrPuppiUpdated"))
)
...
process.patPFMetT1UnclusteredEnDownModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnDownModifiedPFMET"))
)


process.patPFMetT1UnclusteredEnDownPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnDownPuppiUpdated"))
)


process.patPFMetT1UnclusteredEnUpModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnUpModifiedPFMET"))
)


process.patPFMetT1UnclusteredEnUpPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("shiftedPatMETCorrUnclusteredEnUpPuppiUpdated"))
)
...
process.patPFMetT2CorrModifiedPFMET = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    skipEM = cms.bool(True),
...
process.patPFMetT2CorrPuppiUpdated = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag(""),
    skipEM = cms.bool(True),
...
process.patPFMetT2SmearCorrModifiedPFMET = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    skipEM = cms.bool(True),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("selectedPatJetsForMetT2SmearCorrModifiedPFMET"),
    type1JetPtThreshold = cms.double(15.0)
)


process.patPFMetT2SmearCorrPuppiUpdated = cms.EDProducer("PATPFJetMETcorrInputProducer",
    jetCorrLabel = cms.InputTag("L3Absolute"),
    jetCorrLabelRes = cms.InputTag("L2L3Residual"),
    offsetCorrLabel = cms.InputTag("L1FastJet"),
    skipEM = cms.bool(True),
    ...
    skipMuonSelection = cms.string('isGlobalMuon | isStandAloneMuon'),
    skipMuons = cms.bool(True),
    src = cms.InputTag("selectedPatJetsForMetT2SmearCorrPuppiUpdated"),
    type1JetPtThreshold = cms.double(15.0)
)
...
process.patPFMetTxyCorrModifiedPFMET = cms.EDProducer("MultShiftMETcorrInputProducer",
    parameters = cms.VPSet(
        cms.PSet(
            etaMax = cms.double(2.7),
            etaMin = cms.double(0),
...
process.patPFMetTxyCorrPuppiUpdated = cms.EDProducer("MultShiftMETcorrInputProducer",
    parameters = cms.VPSet(
        cms.PSet(
            etaMax = cms.double(2.7),
            etaMin = cms.double(0),
...
process.patPFMetTxyModifiedPFMET = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetModifiedPFMET"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetTxyCorrModifiedPFMET"))
)


process.patPFMetTxyPuppiUpdated = cms.EDProducer("CorrectedPATMETProducer",
    src = cms.InputTag("patPFMetPuppiUpdated"),
    srcCorrections = cms.VInputTag(cms.InputTag("patPFMetTxyCorrPuppiUpdated"))
)
...
process.patSmearedJetsModifiedPFMET = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.patSmearedJetsPuppiUpdated = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.pfCandMETcorrModifiedPFMET = cms.EDProducer("PFCandMETcorrInputProducer",
    src = cms.InputTag("pfCandsNotInJetsForMetCorrModifiedPFMET")
)


process.pfCandMETcorrPuppiUpdated = cms.EDProducer("PFCandMETcorrInputProducer",
    src = cms.InputTag("pfCandsNotInJetsForMetCorrPuppiUpdated")
)
...
process.pfCandsForUnclusteredUncModifiedPFMET = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoEleNoMuNoTauModifiedPFMET"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedPhotons")
)


process.pfCandsForUnclusteredUncPuppiUpdated = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoEleNoMuNoTauPuppiUpdated"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedPhotons")
)


process.pfCandsNoJetsModifiedPFMET = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("packedPFCandidates"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("cleanedPatJetsModifiedPFMET")
)


process.pfCandsNoJetsNoEleModifiedPFMET = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsModifiedPFMET"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedElectrons")
)


process.pfCandsNoJetsNoEleNoMuModifiedPFMET = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoEleModifiedPFMET"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedMuons")
)


process.pfCandsNoJetsNoEleNoMuNoTauModifiedPFMET = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoEleNoMuModifiedPFMET"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedTaus")
)


process.pfCandsNoJetsNoEleNoMuNoTauPuppiUpdated = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoEleNoMuPuppiUpdated"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedTaus")
)


process.pfCandsNoJetsNoEleNoMuPuppiUpdated = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsNoElePuppiUpdated"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedMuons")
)


process.pfCandsNoJetsNoElePuppiUpdated = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("pfCandsNoJetsPuppiUpdated"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("slimmedElectrons")
)


process.pfCandsNoJetsPuppiUpdated = cms.EDProducer("CandPtrProjector",
    src = cms.InputTag("puppiForMET"),
    useDeltaRforFootprint = cms.bool(False),
    veto = cms.InputTag("cleanedPatJetsPuppiUpdated")
)
...
process.pfCandsNotInJetsForMetCorrModifiedPFMET = cms.EDProducer("PFCandidateFromFwdPtrProducer",
    src = cms.InputTag("pfCandsNotInJetsPtrForMetCorr")
)


process.pfCandsNotInJetsForMetCorrPuppiUpdated = cms.EDProducer("PFCandidateFromFwdPtrProducer",
    src = cms.InputTag("pfCandsNotInJetsPtrForMetCorr")
)
...
process.pfCandsNotInJetsPtrForMetCorrModifiedPFMET = cms.EDProducer("TPPFJetsOnPFCandidates",
    bottomCollection = cms.InputTag("particleFlowPtrsModifiedPFMET"),
    enable = cms.bool(True),
    name = cms.untracked.string('noJet'),
    topCollection = cms.InputTag("pfJetsPtrForMetCorrModifiedPFMET"),
    verbose = cms.untracked.bool(False)
)


process.pfCandsNotInJetsPtrForMetCorrPuppiUpdated = cms.EDProducer("TPPFJetsOnPFCandidates",
    bottomCollection = cms.InputTag("particleFlowPtrsPuppiUpdated"),
    enable = cms.bool(True),
    name = cms.untracked.string('noJet'),
    topCollection = cms.InputTag("pfJetsPtrForMetCorrPuppiUpdated"),
    verbose = cms.untracked.bool(False)
)
...
process.pfJetsPtrForMetCorrModifiedPFMET = cms.EDProducer("PFJetFwdPtrProducer",
    src = cms.InputTag("ak4PFJets")
)


process.pfJetsPtrForMetCorrPuppiUpdated = cms.EDProducer("PFJetFwdPtrProducer",
    src = cms.InputTag("ak4PFJets")
)
...
process.pfMetModifiedPFMET = cms.EDProducer("PFMETProducer",
    alias = cms.string('pfMet'),
    calculateSignificance = cms.bool(False),
    globalThreshold = cms.double(0.0),
    src = cms.InputTag("packedPFCandidates")
...
process.pfMetPuppiUpdated = cms.EDProducer("PFMETProducer",
    alias = cms.string('pfMet'),
    calculateSignificance = cms.bool(False),
    globalThreshold = cms.double(0.0),
    src = cms.InputTag("puppiForMET")
...
process.pfMetT1ModifiedPFMET = cms.EDProducer("CorrectedPFMETProducer",
    src = cms.InputTag("pfMet"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrPfMetType1ModifiedPFMET","type1"))
)


process.pfMetT1PuppiUpdated = cms.EDProducer("CorrectedPFMETProducer",
    src = cms.InputTag("pfMet"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrPfMetType1PuppiUpdated","type1"))
)
...
process.pfMetT1T2ModifiedPFMET = cms.EDProducer("CorrectedPFMETProducer",
    src = cms.InputTag("pfMet"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrPfMetType1ModifiedPFMET","type1"), cms.InputTag("corrPfMetType2ModifiedPFMET"))
)


process.pfMetT1T2PuppiUpdated = cms.EDProducer("CorrectedPFMETProducer",
    src = cms.InputTag("pfMet"),
    srcCorrections = cms.VInputTag(cms.InputTag("corrPfMetType1PuppiUpdated","type1"), cms.InputTag("corrPfMetType2PuppiUpdated"))
)
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2Loose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
    inputFileName = cms.FileInPath('RecoTauTag/RecoTau/data/emptyMVAinputFile'),
    key = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2raw","category"),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2Medium = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2Tight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2VLoose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2VTight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVLoose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVTight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationNewDMMVArun2017v2raw = cms.EDProducer("PATTauDiscriminationByMVAIsolationRun2",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Loose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Medium = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Tight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VLoose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VTight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVLoose = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVTight = cms.EDProducer("PATTauDiscriminantCutMultiplexer",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2raw = cms.EDProducer("PATTauDiscriminationByMVAIsolationRun2",
    PATTauProducer = cms.InputTag("slimmedTaus"),
    Prediscriminants = cms.PSet(
        BooleanOperator = cms.string('and')
    ),
...
process.shiftedPatElectronEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfElectronsModifiedPFMET"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.006+0*x):(0.015+0*x))')
)


process.shiftedPatElectronEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfElectronsPuppiUpdated"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.006+0*x):(0.015+0*x))')
)


process.shiftedPatElectronEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfElectronsModifiedPFMET"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.006+0*x):(0.015+0*x))')
)
...
process.shiftedPatElectronEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfElectronsPuppiUpdated"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.006+0*x):(0.015+0*x))')
)
...
process.shiftedPatJetEnDownModifiedPFMET = cms.EDProducer("ShiftedPATJetProducer",
...
process.shiftedPatJetEnDownPuppiUpdated = cms.EDProducer("ShiftedPATJetProducer",
    addResidualJES = cms.bool(True),
...
process.shiftedPatJetEnUpModifiedPFMET = cms.EDProducer("ShiftedPATJetProducer",
    addResidualJES = cms.bool(True),
    jetCorrLabelUpToL3 = cms.InputTag("ak4PFCHSL1FastL2L3Corrector"),
    jetCorrLabelUpToL3Res = cms.InputTag("ak4PFCHSL1FastL2L3ResidualCorrector"),
    jetCorrPayloadName = cms.string('AK4PFchs'),
...
process.shiftedPatJetEnUpPuppiUpdated = cms.EDProducer("ShiftedPATJetProducer",
    addResidualJES = cms.bool(True),
    jetCorrLabelUpToL3 = cms.InputTag("ak4PFPuppiL1FastL2L3Corrector"),
    jetCorrLabelUpToL3Res = cms.InputTag("ak4PFPuppiL1FastL2L3ResidualCorrector"),
    jetCorrPayloadName = cms.string('AK4PFPuppi'),
...
process.shiftedPatJetResDownModifiedPFMET = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatJetResDownPuppiUpdated = cms.EDProducer("SmearedPATJetProducer",
...
process.shiftedPatJetResUpModifiedPFMET = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatJetResUpPuppiUpdated = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFPuppi'),
    algopt = cms.string('AK4PFPuppi_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatMETCorrElectronEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfElectronsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatElectronEnDownModifiedPFMET")
)


process.shiftedPatMETCorrElectronEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfElectronsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatElectronEnDownPuppiUpdated")
)


process.shiftedPatMETCorrElectronEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfElectronsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatElectronEnUpModifiedPFMET")
)


process.shiftedPatMETCorrElectronEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfElectronsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatElectronEnUpPuppiUpdated")
)


process.shiftedPatMETCorrJetEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatJetEnDownModifiedPFMET")
)


process.shiftedPatMETCorrJetEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatJetEnDownPuppiUpdated")
)


process.shiftedPatMETCorrJetEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatJetEnUpModifiedPFMET")
)


process.shiftedPatMETCorrJetEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatJetEnUpPuppiUpdated")
)


process.shiftedPatMETCorrJetResDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatJetResDownModifiedPFMET")
)


process.shiftedPatMETCorrJetResDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatJetResDownPuppiUpdated")
)


process.shiftedPatMETCorrJetResUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatJetResUpModifiedPFMET")
)


process.shiftedPatMETCorrJetResUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("cleanedPatJetsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatJetResUpPuppiUpdated")
)


process.shiftedPatMETCorrMuonEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfMuonsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatMuonEnDownModifiedPFMET")
)


process.shiftedPatMETCorrMuonEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfMuonsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatMuonEnDownPuppiUpdated")
)


process.shiftedPatMETCorrMuonEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfMuonsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatMuonEnUpModifiedPFMET")
)


process.shiftedPatMETCorrMuonEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfMuonsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatMuonEnUpPuppiUpdated")
)


process.shiftedPatMETCorrPhotonEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfPhotonsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatPhotonEnDownModifiedPFMET")
)


process.shiftedPatMETCorrPhotonEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfPhotonsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatPhotonEnDownPuppiUpdated")
)


process.shiftedPatMETCorrPhotonEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfPhotonsModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatPhotonEnUpModifiedPFMET")
)


process.shiftedPatMETCorrPhotonEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfPhotonsPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatPhotonEnUpPuppiUpdated")
)


process.shiftedPatMETCorrSmearedJetResDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatSmearedJetResDownModifiedPFMET")
)


process.shiftedPatMETCorrSmearedJetResDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatSmearedJetResDownPuppiUpdated")
)


process.shiftedPatMETCorrSmearedJetResUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatSmearedJetResUpModifiedPFMET")
)


process.shiftedPatMETCorrSmearedJetResUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("selectedPatJetsForMetT1T2SmearCorrPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatSmearedJetResUpPuppiUpdated")
)


process.shiftedPatMETCorrTauEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfTausModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatTauEnDownModifiedPFMET")
)


process.shiftedPatMETCorrTauEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfTausPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatTauEnDownPuppiUpdated")
)


process.shiftedPatMETCorrTauEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfTausModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatTauEnUpModifiedPFMET")
)


process.shiftedPatMETCorrTauEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfTausPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatTauEnUpPuppiUpdated")
)


process.shiftedPatMETCorrUnclusteredEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfCandsForUnclusteredUncModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatUnclusteredEnDownModifiedPFMET")
)


process.shiftedPatMETCorrUnclusteredEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfCandsForUnclusteredUncPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatUnclusteredEnDownPuppiUpdated")
)


process.shiftedPatMETCorrUnclusteredEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfCandsForUnclusteredUncModifiedPFMET"),
    srcShifted = cms.InputTag("shiftedPatUnclusteredEnUpModifiedPFMET")
)


process.shiftedPatMETCorrUnclusteredEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleMETcorrInputProducer",
    srcOriginal = cms.InputTag("pfCandsForUnclusteredUncPuppiUpdated"),
    srcShifted = cms.InputTag("shiftedPatUnclusteredEnUpPuppiUpdated")
)


process.shiftedPatMuonEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfMuonsModifiedPFMET"),
    uncertainty = cms.string('((x<100)?(0.002+0*y):(0.05+0*y))')
)


process.shiftedPatMuonEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfMuonsPuppiUpdated"),
    uncertainty = cms.string('((x<100)?(0.002+0*y):(0.05+0*y))')
)


process.shiftedPatMuonEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfMuonsModifiedPFMET"),
    uncertainty = cms.string('((x<100)?(0.002+0*y):(0.05+0*y))')
)
...
process.shiftedPatMuonEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfMuonsPuppiUpdated"),
    uncertainty = cms.string('((x<100)?(0.002+0*y):(0.05+0*y))')
)
...
process.shiftedPatPhotonEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfPhotonsModifiedPFMET"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.01+0*x):(0.025+0*x))')
)


process.shiftedPatPhotonEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfPhotonsPuppiUpdated"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.01+0*x):(0.025+0*x))')
)


process.shiftedPatPhotonEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfPhotonsModifiedPFMET"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.01+0*x):(0.025+0*x))')
)
...
process.shiftedPatPhotonEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfPhotonsPuppiUpdated"),
    uncertainty = cms.string('((abs(y)<1.479)?(0.01+0*x):(0.025+0*x))')
)
...
process.shiftedPatSmearedJetResDownModifiedPFMET = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatSmearedJetResDownPuppiUpdated = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFPuppi'),
    algopt = cms.string('AK4PFPuppi_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatSmearedJetResUpModifiedPFMET = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFchs'),
    algopt = cms.string('AK4PFchs_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatSmearedJetResUpPuppiUpdated = cms.EDProducer("SmearedPATJetProducer",
    algo = cms.string('AK4PFPuppi'),
    algopt = cms.string('AK4PFPuppi_pt'),
    dPtMaxFactor = cms.double(3),
    dRMax = cms.double(0.2),
...
process.shiftedPatTauEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfTausModifiedPFMET"),
    uncertainty = cms.string('0.03+0*x*y')
)


process.shiftedPatTauEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfTausPuppiUpdated"),
    uncertainty = cms.string('0.03+0*x*y')
)


process.shiftedPatTauEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfTausModifiedPFMET"),
    uncertainty = cms.string('0.03+0*x*y')
)
...
process.shiftedPatTauEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    shiftBy = cms.double(1.0),
    src = cms.InputTag("pfTausPuppiUpdated"),
    uncertainty = cms.string('0.03+0*x*y')
)
...
process.shiftedPatUnclusteredEnDownModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    binning = cms.VPSet(
        cms.PSet(
    ...
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfCandsForUnclusteredUncModifiedPFMET")
)


process.shiftedPatUnclusteredEnDownPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    binning = cms.VPSet(
        cms.PSet(
            binSelection = cms.string('charge!=0'),
            binUncertainty = cms.string('sqrt(pow(0.00009*x,2)+pow(0.0085/sqrt(sin(2*atan(exp(-y)))),2))')
    ...
    shiftBy = cms.double(-1.0),
    src = cms.InputTag("pfCandsForUnclusteredUncPuppiUpdated")
)


process.shiftedPatUnclusteredEnUpModifiedPFMET = cms.EDProducer("ShiftedParticleProducer",
    binning = cms.VPSet(
        cms.PSet(
            binSelection = cms.string('charge!=0'),
            binUncertainty = cms.string('sqrt(pow(0.00009*x,2)+pow(0.0085/sqrt(sin(2*atan(exp(-y)))),2))')
...
process.shiftedPatUnclusteredEnUpPuppiUpdated = cms.EDProducer("ShiftedParticleProducer",
    binning = cms.VPSet(
        cms.PSet(
            binSelection = cms.string('charge!=0'),
            binUncertainty = cms.string('sqrt(pow(0.00009*x,2)+pow(0.0085/sqrt(sin(2*atan(exp(-y)))),2))')
...
process.slimmedMETsModifiedPFMET = cms.EDProducer("PATMETSlimmer",
    ...
    rawVariation = cms.InputTag("patPFMetModifiedPFMET"),
    runningOnMiniAOD = cms.bool(True),
    src = cms.InputTag("patPFMetT1ModifiedPFMET"),
    t01Variation = cms.InputTag("slimmedMETs","","@skipCurrentProcess"),
    t1SmearedVarsAndUncs = cms.InputTag("patPFMetT1Smear%sModifiedPFMET"),
    t1Uncertainties = cms.InputTag("patPFMetT1%sModifiedPFMET"),
    tXYUncForT1 = cms.InputTag("patPFMetT1TxyModifiedPFMET"),
    trkMET = cms.InputTag("patTrkMet")
)


process.slimmedMETsPuppiUpdated = cms.EDProducer("PATMETSlimmer",
    addDeepMETs = cms.bool(False),
    caloMET = cms.InputTag("patCaloMet"),
    chsMET = cms.InputTag("patCHSMet"),
    deepMETResolutionTune = cms.InputTag("deepMETsResolutionTune"),
    deepMETResponseTune = cms.InputTag("deepMETsResponseTune"),
    rawVariation = cms.InputTag("patPFMetPuppiUpdated"),
    runningOnMiniAOD = cms.bool(True),
    src = cms.InputTag("patPFMetT1PuppiUpdated"),
    t01Variation = cms.InputTag("slimmedMETsPuppi","","@skipCurrentProcess"),
    t1SmearedVarsAndUncs = cms.InputTag("patPFMetT1Smear%sPuppiUpdated"),
    t1Uncertainties = cms.InputTag("patPFMetT1%sPuppiUpdated"),
    tXYUncForT1 = cms.InputTag("patPFMetT1TxyPuppiUpdated"),
    trkMET = cms.InputTag("patTrkMet")
)
...
process.slimmedTausNewID = cms.EDProducer("PATTauIDEmbedder",
    ...
    tauIDSources = cms.PSet(
        ...
        byIsolationMVArun2017v2DBnewDMwLTraw2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2raw"),
        ...
        byLooseIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2Loose"),
        ...
        byMediumIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2Medium"),
        ...
        byTightIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2Tight"),
        ...
        byVLooseIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2VLoose"),
        ...
        byVTightIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2VTight"),
        ...
        byVVLooseIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2VVLoose"),
        ...
        byVVTightIsolationMVArun2017v2DBnewDMwLT2017 = cms.InputTag("rerunDiscriminationByIsolationNewDMMVArun2017v2VVTight"),
...
process.jetSelectorForMetModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string('pt>15 && abs(eta)<9.9'),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("basicJetsForMetModifiedPFMET")
)


process.jetSelectorForMetPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string('pt>15 && abs(eta)<9.9'),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("basicJetsForMetPuppiUpdated")
)
...
process.pfElectronsModifiedPFMET = cms.EDFilter("CandPtrSelector",
    cut = cms.string("pt > 5 && isPF && gsfTrack.isAvailable() && gsfTrack.hitPattern().numberOfLostHits(\'MISSING_INNER_HITS\') < 2"),
    src = cms.InputTag("slimmedElectrons")
)


process.pfElectronsPuppiUpdated = cms.EDFilter("CandPtrSelector",
    cut = cms.string("pt > 5 && isPF && gsfTrack.isAvailable() && gsfTrack.hitPattern().numberOfLostHits(\'MISSING_INNER_HITS\') < 2"),
    src = cms.InputTag("slimmedElectrons")
)
...
process.pfMuonsModifiedPFMET = cms.EDFilter("CandPtrSelector",
    cut = cms.string('pt > 5.0 && isPFMuon && abs(eta) < 2.4'),
    src = cms.InputTag("slimmedMuons")
)


process.pfMuonsPuppiUpdated = cms.EDFilter("CandPtrSelector",
    cut = cms.string('pt > 5.0 && isPFMuon && abs(eta) < 2.4'),
    src = cms.InputTag("slimmedMuons")
)
...
process.pfNoPileUpJMEModifiedPFMET = cms.EDFilter("CandPtrSelector",
    cut = cms.string('fromPV'),
    src = cms.InputTag("packedPFCandidates")
)


process.pfNoPileUpModifiedPFMET = cms.EDFilter("CandPtrSelector",
    cut = cms.string('fromPV > 1'),
    src = cms.InputTag("packedPFCandidates")
)


process.pfNoPileUpPuppiUpdated = cms.EDFilter("CandPtrSelector",
    cut = cms.string(''),
    src = cms.InputTag("puppiForMET")
)


process.pfPhotonsModifiedPFMET = cms.EDFilter("CandPtrSelector",
    cut = cms.string('abs(pdgId) = 22'),
    src = cms.InputTag("pfNoPileUpModifiedPFMET")
)


process.pfPhotonsPuppiUpdated = cms.EDFilter("CandPtrSelector",
    cut = cms.string('abs(pdgId) = 22'),
    src = cms.InputTag("pfNoPileUpPuppiUpdated")
)
...
process.pfTausModifiedPFMET = cms.EDFilter("PATTauRefSelector",
    cut = cms.string('pt > 18.0 & abs(eta) < 2.6 & tauID("decayModeFinding") > 0.5 & isPFTau'),
    src = cms.InputTag("slimmedTaus")
)


process.pfTausPuppiUpdated = cms.EDFilter("PATTauRefSelector",
    cut = cms.string('pt > 18.0 & abs(eta) < 2.6 & tauID("decayModeFinding") > 0.5 & isPFTau'),
    src = cms.InputTag("slimmedTaus")
)
...
process.selectedPatJetsAK4PFPuppiupdated = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAK4PFPuppiupdated")
...
process.selectedPatJetsForMetT1T2CorrModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) < 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patJets")
)
...
process.selectedPatJetsForMetT1T2CorrPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) < 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patJets")
)
...
process.selectedPatJetsForMetT1T2SmearCorrModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) < 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patSmearedJetsModifiedPFMET")
)


process.selectedPatJetsForMetT1T2SmearCorrPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) < 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patSmearedJetsPuppiUpdated")
)
...
process.selectedPatJetsForMetT2CorrModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) > 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patJets")
)
...
process.selectedPatJetsForMetT2CorrPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) > 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patJets")
)
...
process.selectedPatJetsForMetT2SmearCorrModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) > 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patSmearedJetsModifiedPFMET")
)
...
process.selectedPatJetsForMetT2SmearCorrPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string('abs(eta) > 9.9'),
    filter = cms.bool(False),
    src = cms.InputTag("patSmearedJetsPuppiUpdated")
)
...
process.selectedPatJetsModifiedPFMET = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsModifiedPFMET")
...
process.selectedPatJetsPuppiUpdated = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsPuppiUpdated")
...
process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET = cms.EDFilter("PATSingleVertexSelector",
    filter = cms.bool(False),
    mode = cms.string('firstVertex'),
    vertices = cms.InputTag("selectedVerticesForPFMEtCorrType0ModifiedPFMET")
)


process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0PuppiUpdated = cms.EDFilter("PATSingleVertexSelector",
    filter = cms.bool(False),
    mode = cms.string('firstVertex'),
    vertices = cms.InputTag("selectedVerticesForPFMEtCorrType0PuppiUpdated")
)
...
process.selectedVerticesForPFMEtCorrType0ModifiedPFMET = cms.EDFilter("VertexSelector",
    cut = cms.string('isValid & ndof >= 4 & chi2 > 0 & tracksSize > 0 & abs(z) < 24 & abs(position.Rho) < 2.'),
    filter = cms.bool(False),
    src = cms.InputTag("offlinePrimaryVertices")
)
...
process.selectedVerticesForPFMEtCorrType0PuppiUpdated = cms.EDFilter("VertexSelector",
    cut = cms.string('isValid & ndof >= 4 & chi2 > 0 & tracksSize > 0 & abs(z) < 24 & abs(position.Rho) < 2.'),
    filter = cms.bool(False),
    src = cms.InputTag("offlinePrimaryVertices")
)
...
process.ggNtuplizer = cms.EDAnalyzer("ggNtuplizer",
    ...
    ak4PFJetsPUPPISrc = cms.InputTag("selectedPatJetsAK4PFPuppiupdated"),
    ...
    dumpPDFSystWeight = cms.bool(True),
    ...
    patTriggerResults2 = cms.InputTag("TriggerResults","","RECO"),
    pfMETLabel = cms.InputTag("slimmedMETsModifiedPFMET"),
    photonOOTSrc = cms.InputTag("slimmedOOTPhotons"),
    photonSrc = cms.InputTag("slimmedPhotons"),
    pileupCollection = cms.InputTag("slimmedAddPileupInfo"),
    puppiMETLabel = cms.InputTag("slimmedMETsPuppiUpdated"),
...
process.noOutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring(
        'keep *_QGTaggerAK4PFCHSupdated_*_*', 
        'keep *_AK4PFCHSupdatedpileupJetIdEvaluator_*_*', 
        'keep *_selectedPatJetsAK4PFCHSupdated_*_*', 
        'drop *_selectedPatJetsAK4PFCHSupdated_calo*_*', 
        'drop *_selectedPatJetsAK4PFCHSupdated_tagInfos_*', 
        'keep *_selectedPatJetsAK4PFPuppiupdated_*_*', 
        'drop *_selectedPatJetsAK4PFPuppiupdated_calo*_*', 
        'drop *_selectedPatJetsAK4PFPuppiupdated_tagInfos_*'
    )
)
...
process.rerunMvaIsolationTask = cms.Task(process.deepTau2017v1, process.deepTau2017v2p1, process.rerunDiscriminationByIsolationNewDMMVArun2017v2Loose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2Medium, process.rerunDiscriminationByIsolationNewDMMVArun2017v2Tight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VLoose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VTight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVLoose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVTight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2raw, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Loose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Medium, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Tight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VLoose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VTight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVLoose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVTight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2raw)
...
process.patAlgosToolsTask = cms.Task(*[process.AK4PFCHSupdatedpileupJetIdCalculator, process.AK4PFCHSupdatedpileupJetIdEvaluator, process.QGTaggerAK4PFCHSupdated, process.ak4CaloL2L3CorrectorModifiedPFMET, process.ak4CaloL2L3CorrectorPuppiUpdated, process.ak4CaloL2L3ResidualCorrectorModifiedPFMET, process.ak4CaloL2L3ResidualCorrectorPuppiUpdated, process.ak4CaloL2RelativeCorrectorModifiedPFMET, process.ak4CaloL2RelativeCorrectorPuppiUpdated, process.ak4CaloL3AbsoluteCorrectorModifiedPFMET, process.ak4CaloL3AbsoluteCorrectorPuppiUpdated, process.ak4CaloResidualCorrectorModifiedPFMET, process.ak4CaloResidualCorrectorPuppiUpdated, process.ak4GenJetsNoNu, process.ak4PFCHSL1FastL2L3CorrectorModifiedPFMET, process.ak4PFCHSL1FastL2L3CorrectorPuppiUpdated, process.ak4PFCHSL1FastL2L3ResidualCorrectorModifiedPFMET, process.ak4PFCHSL1FastL2L3ResidualCorrectorPuppiUpdated, process.ak4PFCHSL1FastjetCorrectorModifiedPFMET, process.ak4PFCHSL1FastjetCorrectorPuppiUpdated, process.ak4PFCHSL2RelativeCorrectorModifiedPFMET, process.ak4PFCHSL2RelativeCorrectorPuppiUpdated, process.ak4PFCHSL3AbsoluteCorrectorModifiedPFMET, process.ak4PFCHSL3AbsoluteCorrectorPuppiUpdated, process.ak4PFCHSResidualCorrectorModifiedPFMET, process.ak4PFCHSResidualCorrectorPuppiUpdated, process.ak4PFJetsCHSModifiedPFMET, process.ak4PFJetsCHSupdated, process.ak4PFJetsCHSupdatedConstituents, process.ak4PFJetsPuppiUpdated, process.ak4PFJetsPuppiupdated, process.ak4PFJetsPuppiupdatedConstituents, process.basicJetsForMetModifiedPFMET, process.basicJetsForMetPuppiUpdated, process.caloMetT1ModifiedPFMET, process.caloMetT1PuppiUpdated, process.caloMetT1T2ModifiedPFMET, process.caloMetT1T2PuppiUpdated, process.chs, process.cleanedPatJetsModifiedPFMET, process.cleanedPatJetsPuppiUpdated, process.corrCaloMetType1ModifiedPFMET, process.corrCaloMetType1PuppiUpdated, process.corrCaloMetType2ModifiedPFMET, process.corrCaloMetType2PuppiUpdated, process.corrPfMetType1ModifiedPFMET, process.corrPfMetType1PuppiUpdated, process.corrPfMetType2ModifiedPFMET, process.corrPfMetType2PuppiUpdated, process.genMetExtractorModifiedPFMET, process.genMetExtractorPuppiUpdated, process.jetCorrectorsTask, process.jetSelectorForMetModifiedPFMET, process.jetSelectorForMetPuppiUpdated, process.makePatMETsTask, process.metrawCaloModifiedPFMET, process.metrawCaloPuppiUpdated, process.muCaloMetCorrModifiedPFMET, process.muCaloMetCorrPuppiUpdated, process.packedGenParticlesForJetsNoNu, process.particleFlowPtrsModifiedPFMET, process.particleFlowPtrsPuppiUpdated, process.patCHSMet, process.patCaloMet, process.patJetCorrFactorsAK4PFCHSupdated, process.patJetCorrFactorsAK4PFPuppiupdated, process.patJetCorrFactorsModifiedPFMET, process.patJetCorrFactorsPuppiUpdated, process.patJetFlavourAssociationAK4PFCHSupdated, process.patJetFlavourAssociationAK4PFPuppiupdated, process.patJetFlavourAssociationLegacyAK4PFCHSupdated, process.patJetFlavourAssociationLegacyAK4PFPuppiupdated, process.patJetFlavourAssociationLegacyModifiedPFMET, process.patJetFlavourAssociationLegacyPuppiUpdated, process.patJetFlavourAssociationModifiedPFMET, process.patJetFlavourAssociationPuppiUpdated, process.patJetGenJetMatchAK4PFCHSupdated, process.patJetGenJetMatchAK4PFPuppiupdated, process.patJetGenJetMatchModifiedPFMET, process.patJetGenJetMatchPuppiUpdated, process.patJetPartonAssociationLegacyAK4PFCHSupdated, process.patJetPartonAssociationLegacyAK4PFPuppiupdated, process.patJetPartonAssociationLegacyModifiedPFMET, process.patJetPartonAssociationLegacyPuppiUpdated, process.patJetPartonMatchAK4PFCHSupdated, process.patJetPartonMatchAK4PFPuppiupdated, process.patJetPartonMatchModifiedPFMET, process.patJetPartonMatchPuppiUpdated, process.patJetPartonsLegacyModifiedPFMET, process.patJetPartonsLegacyPuppiUpdated, process.patJetPartonsLegacyupdated, process.patJetPartonsModifiedPFMET, process.patJetPartonsPuppiUpdated, process.patJetPartonsupdated, process.patJetsAK4PFCHSupdated, process.patJetsAK4PFCHSupdatedPATJetswithUserData, process.patJetsAK4PFCHSupdatedlooseJetId, process.patJetsAK4PFCHSupdatedtightJetId, process.patJetsAK4PFCHSupdatedtightJetIdLepVeto, process.patJetsAK4PFPuppiupdated, process.patJetsAK4PFPuppiupdatedPATJetswithUserData, process.patJetsAK4PFPuppiupdatedlooseJetId, process.patJetsAK4PFPuppiupdatedtightJetId, process.patJetsAK4PFPuppiupdatedtightJetIdLepVeto, process.patJetsModifiedPFMET, process.patJetsPuppiUpdated, process.patPFMetModifiedPFMET, process.patPFMetPuppiUpdated, process.patPFMetT0CorrModifiedPFMET, process.patPFMetT0CorrPuppiUpdated, process.patPFMetT0pcT1ModifiedPFMET, process.patPFMetT0pcT1PuppiUpdated, process.patPFMetT0pcT1T2ModifiedPFMET, process.patPFMetT0pcT1T2PuppiUpdated, process.patPFMetT1ElectronEnDownModifiedPFMET, process.patPFMetT1ElectronEnDownPuppiUpdated, process.patPFMetT1ElectronEnUpModifiedPFMET, process.patPFMetT1ElectronEnUpPuppiUpdated, process.patPFMetT1JetEnDownModifiedPFMET, process.patPFMetT1JetEnDownPuppiUpdated, process.patPFMetT1JetEnUpModifiedPFMET, process.patPFMetT1JetEnUpPuppiUpdated, process.patPFMetT1JetResDownModifiedPFMET, process.patPFMetT1JetResDownPuppiUpdated, process.patPFMetT1JetResUpModifiedPFMET, process.patPFMetT1JetResUpPuppiUpdated, process.patPFMetT1ModifiedPFMET, process.patPFMetT1MuonEnDownModifiedPFMET, process.patPFMetT1MuonEnDownPuppiUpdated, process.patPFMetT1MuonEnUpModifiedPFMET, process.patPFMetT1MuonEnUpPuppiUpdated, process.patPFMetT1PhotonEnDownModifiedPFMET, process.patPFMetT1PhotonEnDownPuppiUpdated, process.patPFMetT1PhotonEnUpModifiedPFMET, process.patPFMetT1PhotonEnUpPuppiUpdated, process.patPFMetT1PuppiUpdated, process.patPFMetT1SmearElectronEnDownModifiedPFMET, process.patPFMetT1SmearElectronEnDownPuppiUpdated, process.patPFMetT1SmearElectronEnUpModifiedPFMET, process.patPFMetT1SmearElectronEnUpPuppiUpdated, process.patPFMetT1SmearJetEnDownModifiedPFMET, process.patPFMetT1SmearJetEnDownPuppiUpdated, process.patPFMetT1SmearJetEnUpModifiedPFMET, process.patPFMetT1SmearJetEnUpPuppiUpdated, process.patPFMetT1SmearJetResDownModifiedPFMET, process.patPFMetT1SmearJetResDownPuppiUpdated, process.patPFMetT1SmearJetResUpModifiedPFMET, process.patPFMetT1SmearJetResUpPuppiUpdated, process.patPFMetT1SmearModifiedPFMET, process.patPFMetT1SmearMuonEnDownModifiedPFMET, process.patPFMetT1SmearMuonEnDownPuppiUpdated, process.patPFMetT1SmearMuonEnUpModifiedPFMET, process.patPFMetT1SmearMuonEnUpPuppiUpdated, process.patPFMetT1SmearPhotonEnDownModifiedPFMET, process.patPFMetT1SmearPhotonEnDownPuppiUpdated, process.patPFMetT1SmearPhotonEnUpModifiedPFMET, process.patPFMetT1SmearPhotonEnUpPuppiUpdated, process.patPFMetT1SmearPuppiUpdated, process.patPFMetT1SmearTauEnDownModifiedPFMET, process.patPFMetT1SmearTauEnDownPuppiUpdated, process.patPFMetT1SmearTauEnUpModifiedPFMET, process.patPFMetT1SmearTauEnUpPuppiUpdated, process.patPFMetT1SmearUnclusteredEnDownModifiedPFMET, process.patPFMetT1SmearUnclusteredEnDownPuppiUpdated, process.patPFMetT1SmearUnclusteredEnUpModifiedPFMET, process.patPFMetT1SmearUnclusteredEnUpPuppiUpdated, process.patPFMetT1T2CorrModifiedPFMET, process.patPFMetT1T2CorrPuppiUpdated, process.patPFMetT1T2ModifiedPFMET, process.patPFMetT1T2PuppiUpdated, process.patPFMetT1T2SmearCorrModifiedPFMET, process.patPFMetT1T2SmearCorrPuppiUpdated, process.patPFMetT1TauEnDownModifiedPFMET, process.patPFMetT1TauEnDownPuppiUpdated, process.patPFMetT1TauEnUpModifiedPFMET, process.patPFMetT1TauEnUpPuppiUpdated, process.patPFMetT1TxyModifiedPFMET, process.patPFMetT1TxyPuppiUpdated, process.patPFMetT1UnclusteredEnDownModifiedPFMET, process.patPFMetT1UnclusteredEnDownPuppiUpdated, process.patPFMetT1UnclusteredEnUpModifiedPFMET, process.patPFMetT1UnclusteredEnUpPuppiUpdated, process.patPFMetT2CorrModifiedPFMET, process.patPFMetT2CorrPuppiUpdated, process.patPFMetT2SmearCorrModifiedPFMET, process.patPFMetT2SmearCorrPuppiUpdated, process.patPFMetT2SmearCorrTask, process.patPFMetTxyCorrModifiedPFMET, process.patPFMetTxyCorrPuppiUpdated, process.patPFMetTxyCorrTask, process.patPFMetTxyModifiedPFMET, process.patPFMetTxyPuppiUpdated, process.patSmearedJetsModifiedPFMET, process.patSmearedJetsPuppiUpdated, process.patTrkMet, process.pfCHS, process.pfCandMETcorrModifiedPFMET, process.pfCandMETcorrPuppiUpdated, process.pfCandsForUnclusteredUncModifiedPFMET, process.pfCandsForUnclusteredUncPuppiUpdated, process.pfCandsNoJetsModifiedPFMET, process.pfCandsNoJetsNoEleModifiedPFMET, process.pfCandsNoJetsNoEleNoMuModifiedPFMET, process.pfCandsNoJetsNoEleNoMuNoTauModifiedPFMET, process.pfCandsNoJetsNoEleNoMuNoTauPuppiUpdated, process.pfCandsNoJetsNoEleNoMuPuppiUpdated, process.pfCandsNoJetsNoElePuppiUpdated, process.pfCandsNoJetsPuppiUpdated, process.pfCandsNotInJetsForMetCorrModifiedPFMET, process.pfCandsNotInJetsForMetCorrPuppiUpdated, process.pfCandsNotInJetsPtrForMetCorrModifiedPFMET, process.pfCandsNotInJetsPtrForMetCorrPuppiUpdated, process.pfElectronsModifiedPFMET, process.pfElectronsPuppiUpdated, process.pfJetsPtrForMetCorrModifiedPFMET, process.pfJetsPtrForMetCorrPuppiUpdated, process.pfLeptonsPUPPET, process.pfMetCHS, process.pfMetModifiedPFMET, process.pfMetPuppiUpdated, process.pfMetT1ModifiedPFMET, process.pfMetT1PuppiUpdated, process.pfMetT1T2ModifiedPFMET, process.pfMetT1T2PuppiUpdated, process.pfMetTrk, process.pfMuonsModifiedPFMET, process.pfMuonsPuppiUpdated, process.pfNoLepPUPPI, process.pfNoPileUpJMEModifiedPFMET, process.pfNoPileUpModifiedPFMET, process.pfNoPileUpPuppiUpdated, process.pfPhotonsModifiedPFMET, process.pfPhotonsPuppiUpdated, process.pfTausModifiedPFMET, process.pfTausPuppiUpdated, process.pfTrk, process.producePatPFMETCorrectionsTask, process.puppi, process.puppiForMET, process.puppiMerged, process.puppiNoLep, process.puppiPhoton, process.selectedPatJetsAK4PFCHSupdated, process.selectedPatJetsAK4PFPuppiupdated, process.selectedPatJetsForMetT1T2CorrModifiedPFMET, process.selectedPatJetsForMetT1T2CorrPuppiUpdated, process.selectedPatJetsForMetT1T2SmearCorrModifiedPFMET, process.selectedPatJetsForMetT1T2SmearCorrPuppiUpdated, process.selectedPatJetsForMetT2CorrModifiedPFMET, process.selectedPatJetsForMetT2CorrPuppiUpdated, process.selectedPatJetsForMetT2SmearCorrModifiedPFMET, process.selectedPatJetsForMetT2SmearCorrPuppiUpdated, process.selectedPatJetsModifiedPFMET, process.selectedPatJetsPuppiUpdated, process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET, process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0PuppiUpdated, process.selectedVerticesForPFMEtCorrType0ModifiedPFMET, process.selectedVerticesForPFMEtCorrType0PuppiUpdated, process.shiftedPatElectronEnDownModifiedPFMET, process.shiftedPatElectronEnDownPuppiUpdated, process.shiftedPatElectronEnUpModifiedPFMET, process.shiftedPatElectronEnUpPuppiUpdated, process.shiftedPatJetEnDownModifiedPFMET, process.shiftedPatJetEnDownPuppiUpdated, process.shiftedPatJetEnUpModifiedPFMET, process.shiftedPatJetEnUpPuppiUpdated, process.shiftedPatJetResDownModifiedPFMET, process.shiftedPatJetResDownPuppiUpdated, process.shiftedPatJetResUpModifiedPFMET, process.shiftedPatJetResUpPuppiUpdated, process.shiftedPatMETCorrElectronEnDownModifiedPFMET, process.shiftedPatMETCorrElectronEnDownPuppiUpdated, process.shiftedPatMETCorrElectronEnUpModifiedPFMET, process.shiftedPatMETCorrElectronEnUpPuppiUpdated, process.shiftedPatMETCorrJetEnDownModifiedPFMET, process.shiftedPatMETCorrJetEnDownPuppiUpdated, process.shiftedPatMETCorrJetEnUpModifiedPFMET, process.shiftedPatMETCorrJetEnUpPuppiUpdated, process.shiftedPatMETCorrJetResDownModifiedPFMET, process.shiftedPatMETCorrJetResDownPuppiUpdated, process.shiftedPatMETCorrJetResUpModifiedPFMET, process.shiftedPatMETCorrJetResUpPuppiUpdated, process.shiftedPatMETCorrMuonEnDownModifiedPFMET, process.shiftedPatMETCorrMuonEnDownPuppiUpdated, process.shiftedPatMETCorrMuonEnUpModifiedPFMET, process.shiftedPatMETCorrMuonEnUpPuppiUpdated, process.shiftedPatMETCorrPhotonEnDownModifiedPFMET, process.shiftedPatMETCorrPhotonEnDownPuppiUpdated, process.shiftedPatMETCorrPhotonEnUpModifiedPFMET, process.shiftedPatMETCorrPhotonEnUpPuppiUpdated, process.shiftedPatMETCorrSmearedJetResDownModifiedPFMET, process.shiftedPatMETCorrSmearedJetResDownPuppiUpdated, process.shiftedPatMETCorrSmearedJetResUpModifiedPFMET, process.shiftedPatMETCorrSmearedJetResUpPuppiUpdated, process.shiftedPatMETCorrTauEnDownModifiedPFMET, process.shiftedPatMETCorrTauEnDownPuppiUpdated, process.shiftedPatMETCorrTauEnUpModifiedPFMET, process.shiftedPatMETCorrTauEnUpPuppiUpdated, process.shiftedPatMETCorrUnclusteredEnDownModifiedPFMET, process.shiftedPatMETCorrUnclusteredEnDownPuppiUpdated, process.shiftedPatMETCorrUnclusteredEnUpModifiedPFMET, process.shiftedPatMETCorrUnclusteredEnUpPuppiUpdated, process.shiftedPatMuonEnDownModifiedPFMET, process.shiftedPatMuonEnDownPuppiUpdated, process.shiftedPatMuonEnUpModifiedPFMET, process.shiftedPatMuonEnUpPuppiUpdated, process.shiftedPatPhotonEnDownModifiedPFMET, process.shiftedPatPhotonEnDownPuppiUpdated, process.shiftedPatPhotonEnUpModifiedPFMET, process.shiftedPatPhotonEnUpPuppiUpdated, process.shiftedPatSmearedJetResDownModifiedPFMET, process.shiftedPatSmearedJetResDownPuppiUpdated, process.shiftedPatSmearedJetResUpModifiedPFMET, process.shiftedPatSmearedJetResUpPuppiUpdated, process.shiftedPatTauEnDownModifiedPFMET, process.shiftedPatTauEnDownPuppiUpdated, process.shiftedPatTauEnUpModifiedPFMET, process.shiftedPatTauEnUpPuppiUpdated, process.shiftedPatUnclusteredEnDownModifiedPFMET, process.shiftedPatUnclusteredEnDownPuppiUpdated, process.shiftedPatUnclusteredEnUpModifiedPFMET, process.shiftedPatUnclusteredEnUpPuppiUpdated, process.slimmedMETsModifiedPFMET, process.slimmedMETsPuppiUpdated])
...
process.patPFMetSmearCorrSequenceModifiedPFMET = cms.Sequence(process.patSmearedJetsModifiedPFMET+process.selectedPatJetsForMetT1T2SmearCorrModifiedPFMET+process.patPFMetT1T2SmearCorrModifiedPFMET)
...
process.patPFMetT1SmearPuppiUpdatedpatShiftedModuleSequencePuppiUpdated = cms.Sequence(process.patPFMetT1SmearJetResUpPuppiUpdated+process.patPFMetT1SmearJetResDownPuppiUpdated+process.patPFMetT1SmearMuonEnUpPuppiUpdated+process.patPFMetT1SmearMuonEnDownPuppiUpdated+process.patPFMetT1SmearJetEnUpPuppiUpdated+process.patPFMetT1SmearJetEnDownPuppiUpdated+process.patPFMetT1SmearTauEnDownPuppiUpdated+process.patPFMetT1SmearTauEnUpPuppiUpdated+process.patPFMetT1SmearPhotonEnUpPuppiUpdated+process.patPFMetT1SmearPhotonEnDownPuppiUpdated+process.patPFMetT1SmearElectronEnUpPuppiUpdated+process.patPFMetT1SmearElectronEnDownPuppiUpdated+process.patPFMetT1SmearUnclusteredEnDownPuppiUpdated+process.patPFMetT1SmearUnclusteredEnUpPuppiUpdated)


process.patPFMetT2CorrSequenceModifiedPFMET = cms.Sequence(process.patPFMetT2CorrModifiedPFMET)


process.patMetModuleSequencePuppiUpdated = cms.Sequence(process.pfMetPuppiUpdated+process.ak4PFJetsPuppiUpdated+process.patJetCorrFactorsPuppiUpdated+process.patJetsPuppiUpdated+process.basicJetsForMetPuppiUpdated+process.jetSelectorForMetPuppiUpdated+process.cleanedPatJetsPuppiUpdated+process.metrawCaloPuppiUpdated+process.genMetExtractorPuppiUpdated+process.pfCHS+process.pfMetCHS+process.patCHSMet+process.pfTrk+process.pfMetTrk+process.patTrkMet+process.patPFMetPuppiUpdated)
...
process.patPFMetT2CorrSequencePuppiUpdated = cms.Sequence(process.patPFMetT2CorrPuppiUpdated)


process.producePatPFMETCorrectionsModifiedPFMET = cms.Sequence(process.patPFMetModifiedPFMET+process.pfCandsNotInJetsForMetCorrModifiedPFMET+process.selectedPatJetsForMetT1T2CorrModifiedPFMET+process.selectedPatJetsForMetT2CorrModifiedPFMET+process.patPFMetT1T2CorrModifiedPFMET+process.patPFMetT2CorrModifiedPFMET+process.selectedVerticesForPFMEtCorrType0ModifiedPFMET+process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET+process.particleFlowDisplacedVertex+process.pfCandidateToVertexAssociation+process.patPFMetT0CorrModifiedPFMET+process.pfCandMETcorrModifiedPFMET+process.patPFMetT1ModifiedPFMET+process.patPFMetT1T2ModifiedPFMET+process.patPFMetT0pcT1ModifiedPFMET+process.patPFMetT0pcT1T2ModifiedPFMET)
...
process.patPFMetT1T2CorrSequenceModifiedPFMET = cms.Sequence(process.patPFMetT1T2CorrModifiedPFMET)
...
process.patPFMetT0CorrSequenceModifiedPFMET = cms.Sequence(process.selectedVerticesForPFMEtCorrType0ModifiedPFMET+process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET+process.particleFlowDisplacedVertex+process.pfCandidateToVertexAssociation+process.patPFMetT0CorrModifiedPFMET)
...
process.producePatPFMETCorrectionsPuppiUpdated = cms.Sequence(process.patPFMetPuppiUpdated+process.pfCandsNotInJetsForMetCorrPuppiUpdated+process.selectedPatJetsForMetT1T2CorrPuppiUpdated+process.selectedPatJetsForMetT2CorrPuppiUpdated+process.patPFMetT1T2CorrPuppiUpdated+process.patPFMetT2CorrPuppiUpdated+process.selectedVerticesForPFMEtCorrType0PuppiUpdated+process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0PuppiUpdated+process.particleFlowDisplacedVertex+process.pfCandidateToVertexAssociation+process.patPFMetT0CorrPuppiUpdated+process.pfCandMETcorrPuppiUpdated+process.patPFMetT1PuppiUpdated+process.patPFMetT1T2PuppiUpdated+process.patPFMetT0pcT1PuppiUpdated+process.patPFMetT0pcT1T2PuppiUpdated)


process.patShiftedModuleSequencePuppiUpdated = cms.Sequence(process.patPFMetT1JetResDownPuppiUpdated+process.patPFMetT1JetResUpPuppiUpdated+process.patPFMetT1MuonEnUpPuppiUpdated+process.patPFMetT1MuonEnDownPuppiUpdated+process.patPFMetT1JetEnDownPuppiUpdated+process.patPFMetT1JetEnUpPuppiUpdated+process.patPFMetT1TauEnDownPuppiUpdated+process.patPFMetT1TauEnUpPuppiUpdated+process.patPFMetT1PhotonEnUpPuppiUpdated+process.patPFMetT1PhotonEnDownPuppiUpdated+process.patPFMetT1ElectronEnDownPuppiUpdated+process.patPFMetT1ElectronEnUpPuppiUpdated+process.patPFMetT1UnclusteredEnUpPuppiUpdated+process.patPFMetT1UnclusteredEnDownPuppiUpdated+process.patPFMetT1SmearPuppiUpdatedpatShiftedModuleSequencePuppiUpdated)
...
process.patPFMetT1T2CorrSequencePuppiUpdated = cms.Sequence(process.patPFMetT1T2CorrPuppiUpdated)
...
process.patPFMetSmearCorrSequencePuppiUpdated = cms.Sequence(process.patSmearedJetsPuppiUpdated+process.selectedPatJetsForMetT1T2SmearCorrPuppiUpdated+process.patPFMetT1T2SmearCorrPuppiUpdated)


process.ak4JetSubs = cms.Sequence(process.packedGenParticlesForJetsNoNu+process.ak4GenJetsNoNu+process.puppi+process.ak4PFJetsPuppiupdated+process.ak4PFJetsPuppiupdatedConstituents+process.patJetsAK4PFPuppiupdatedPATJetswithUserData)
...
process.patPFMetTxyCorrSequenceModifiedPFMET = cms.Sequence(process.patPFMetTxyCorrModifiedPFMET)
...
process.patPFMetT1SmearPuppiUpdatedpatMetUncertaintySequencePuppiUpdated = cms.Sequence(process.shiftedPatSmearedJetResDownPuppiUpdated+process.shiftedPatMETCorrSmearedJetResDownPuppiUpdated+process.shiftedPatSmearedJetResUpPuppiUpdated+process.shiftedPatMETCorrSmearedJetResUpPuppiUpdated+process.pfElectronsPuppiUpdated+process.pfTausPuppiUpdated+process.pfMuonsPuppiUpdated+process.pfNoPileUpPuppiUpdated+process.pfPhotonsPuppiUpdated)
...
process.patPFMetT2SmearCorrSequenceModifiedPFMET = cms.Sequence(process.patSmearedJetsModifiedPFMET+process.selectedPatJetsForMetT1T2SmearCorrModifiedPFMET+process.selectedPatJetsForMetT2SmearCorrModifiedPFMET+process.patPFMetT1T2SmearCorrModifiedPFMET+process.patPFMetT2SmearCorrModifiedPFMET)
...
process.patPFMetT1SmearModifiedPFMETpatMetUncertaintySequenceModifiedPFMET = cms.Sequence(process.shiftedPatSmearedJetResDownModifiedPFMET+process.shiftedPatMETCorrSmearedJetResDownModifiedPFMET+process.shiftedPatSmearedJetResUpModifiedPFMET+process.shiftedPatMETCorrSmearedJetResUpModifiedPFMET+process.pfElectronsModifiedPFMET+process.pfTausModifiedPFMET+process.pfMuonsModifiedPFMET+process.pfNoPileUpModifiedPFMET+process.pfPhotonsModifiedPFMET)


process.patMetModuleSequenceModifiedPFMET = cms.Sequence(process.pfMetModifiedPFMET+process.pfNoPileUpJMEModifiedPFMET+process.ak4PFJetsCHSModifiedPFMET+process.patJetCorrFactorsModifiedPFMET+process.patJetsModifiedPFMET+process.basicJetsForMetModifiedPFMET+process.jetSelectorForMetModifiedPFMET+process.cleanedPatJetsModifiedPFMET+process.metrawCaloModifiedPFMET+process.genMetExtractorModifiedPFMET+process.pfCHS+process.pfMetCHS+process.patCHSMet+process.pfTrk+process.pfMetTrk+process.patTrkMet+process.patPFMetModifiedPFMET)


process.patMETCorrectionsPuppiUpdated = cms.Sequence(process.ak4CaloL2RelativeCorrectorPuppiUpdated+process.ak4CaloL3AbsoluteCorrectorPuppiUpdated+process.ak4CaloL2L3CorrectorPuppiUpdated+process.ak4CaloL2RelativeCorrectorPuppiUpdated+process.ak4CaloL3AbsoluteCorrectorPuppiUpdated+process.ak4CaloResidualCorrectorPuppiUpdated+process.ak4CaloL2L3ResidualCorrectorPuppiUpdated+process.corrCaloMetType1PuppiUpdated+process.muCaloMetCorrPuppiUpdated+process.corrCaloMetType2PuppiUpdated+process.caloMetT1PuppiUpdated+process.caloMetT1T2PuppiUpdated+process.pfJetsPtrForMetCorrPuppiUpdated+process.particleFlowPtrsPuppiUpdated+process.pfCandsNotInJetsPtrForMetCorrPuppiUpdated+process.pfCandsNotInJetsForMetCorrPuppiUpdated+process.pfCandMETcorrPuppiUpdated+process.ak4PFCHSL1FastjetCorrectorPuppiUpdated+process.ak4PFCHSL2RelativeCorrectorPuppiUpdated+process.ak4PFCHSL3AbsoluteCorrectorPuppiUpdated+process.ak4PFCHSResidualCorrectorPuppiUpdated+process.ak4PFCHSL1FastL2L3ResidualCorrectorPuppiUpdated+process.ak4PFCHSL1FastjetCorrectorPuppiUpdated+process.ak4PFCHSL2RelativeCorrectorPuppiUpdated+process.ak4PFCHSL3AbsoluteCorrectorPuppiUpdated+process.ak4PFCHSL1FastL2L3CorrectorPuppiUpdated+process.corrPfMetType1PuppiUpdated+process.corrPfMetType2PuppiUpdated+process.pfMetT1PuppiUpdated+process.pfMetT1T2PuppiUpdated)


process.correctionTermsCaloMet = cms.Sequence(process.correctionTermsCaloMetTask)


process.patMETCorrectionsModifiedPFMET = cms.Sequence(process.ak4CaloL2RelativeCorrectorModifiedPFMET+process.ak4CaloL3AbsoluteCorrectorModifiedPFMET+process.ak4CaloL2L3CorrectorModifiedPFMET+process.ak4CaloL2RelativeCorrectorModifiedPFMET+process.ak4CaloL3AbsoluteCorrectorModifiedPFMET+process.ak4CaloResidualCorrectorModifiedPFMET+process.ak4CaloL2L3ResidualCorrectorModifiedPFMET+process.corrCaloMetType1ModifiedPFMET+process.muCaloMetCorrModifiedPFMET+process.corrCaloMetType2ModifiedPFMET+process.caloMetT1ModifiedPFMET+process.caloMetT1T2ModifiedPFMET+process.pfJetsPtrForMetCorrModifiedPFMET+process.particleFlowPtrsModifiedPFMET+process.pfCandsNotInJetsPtrForMetCorrModifiedPFMET+process.pfCandsNotInJetsForMetCorrModifiedPFMET+process.pfCandMETcorrModifiedPFMET+process.ak4PFCHSL1FastjetCorrectorModifiedPFMET+process.ak4PFCHSL2RelativeCorrectorModifiedPFMET+process.ak4PFCHSL3AbsoluteCorrectorModifiedPFMET+process.ak4PFCHSResidualCorrectorModifiedPFMET+process.ak4PFCHSL1FastL2L3ResidualCorrectorModifiedPFMET+process.ak4PFCHSL1FastjetCorrectorModifiedPFMET+process.ak4PFCHSL2RelativeCorrectorModifiedPFMET+process.ak4PFCHSL3AbsoluteCorrectorModifiedPFMET+process.ak4PFCHSL1FastL2L3CorrectorModifiedPFMET+process.corrPfMetType1ModifiedPFMET+process.corrPfMetType2ModifiedPFMET+process.pfMetT1ModifiedPFMET+process.pfMetT1T2ModifiedPFMET)
...
process.patPFMetT1SmearModifiedPFMETpatShiftedModuleSequenceModifiedPFMET = cms.Sequence(process.patPFMetT1SmearJetResUpModifiedPFMET+process.patPFMetT1SmearJetResDownModifiedPFMET+process.patPFMetT1SmearMuonEnDownModifiedPFMET+process.patPFMetT1SmearMuonEnUpModifiedPFMET+process.patPFMetT1SmearJetEnUpModifiedPFMET+process.patPFMetT1SmearJetEnDownModifiedPFMET+process.patPFMetT1SmearTauEnUpModifiedPFMET+process.patPFMetT1SmearTauEnDownModifiedPFMET+process.patPFMetT1SmearPhotonEnUpModifiedPFMET+process.patPFMetT1SmearPhotonEnDownModifiedPFMET+process.patPFMetT1SmearElectronEnDownModifiedPFMET+process.patPFMetT1SmearElectronEnUpModifiedPFMET+process.patPFMetT1SmearUnclusteredEnUpModifiedPFMET+process.patPFMetT1SmearUnclusteredEnDownModifiedPFMET)


process.patMetUncertaintySequenceModifiedPFMET = cms.Sequence(process.ak4PFCHSL1FastL2L3CorrectorChain+process.ak4PFCHSL1FastL2L3ResidualCorrectorChain+process.shiftedPatJetResDownModifiedPFMET+process.shiftedPatMETCorrJetResDownModifiedPFMET+process.shiftedPatJetResUpModifiedPFMET+process.shiftedPatMETCorrJetResUpModifiedPFMET+process.pfCandsNoJetsModifiedPFMET+process.pfCandsNoJetsNoEleModifiedPFMET+process.pfCandsNoJetsNoEleNoMuModifiedPFMET+process.pfCandsNoJetsNoEleNoMuNoTauModifiedPFMET+process.pfCandsForUnclusteredUncModifiedPFMET+process.pfElectronsModifiedPFMET+process.pfTausModifiedPFMET+process.pfMuonsModifiedPFMET+process.pfNoPileUpModifiedPFMET+process.pfPhotonsModifiedPFMET+process.shiftedPatMuonEnDownModifiedPFMET+process.shiftedPatMETCorrMuonEnDownModifiedPFMET+process.shiftedPatMuonEnUpModifiedPFMET+process.shiftedPatMETCorrMuonEnUpModifiedPFMET+process.shiftedPatJetEnDownModifiedPFMET+process.shiftedPatMETCorrJetEnDownModifiedPFMET+process.shiftedPatJetEnUpModifiedPFMET+process.shiftedPatMETCorrJetEnUpModifiedPFMET+process.shiftedPatTauEnDownModifiedPFMET+process.shiftedPatMETCorrTauEnDownModifiedPFMET+process.shiftedPatTauEnUpModifiedPFMET+process.shiftedPatMETCorrTauEnUpModifiedPFMET+process.shiftedPatPhotonEnDownModifiedPFMET+process.shiftedPatMETCorrPhotonEnDownModifiedPFMET+process.shiftedPatPhotonEnUpModifiedPFMET+process.shiftedPatMETCorrPhotonEnUpModifiedPFMET+process.shiftedPatElectronEnDownModifiedPFMET+process.shiftedPatMETCorrElectronEnDownModifiedPFMET+process.shiftedPatElectronEnUpModifiedPFMET+process.shiftedPatMETCorrElectronEnUpModifiedPFMET+process.shiftedPatUnclusteredEnDownModifiedPFMET+process.shiftedPatMETCorrUnclusteredEnDownModifiedPFMET+process.shiftedPatUnclusteredEnUpModifiedPFMET+process.shiftedPatMETCorrUnclusteredEnUpModifiedPFMET+process.patPFMetT1SmearModifiedPFMETpatMetUncertaintySequenceModifiedPFMET)
...
process.rerunMvaIsolationSequence = cms.Sequence(cms.Sequence(cms.Task(process.rerunDiscriminationByIsolationNewDMMVArun2017v2Loose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2Medium, process.rerunDiscriminationByIsolationNewDMMVArun2017v2Tight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VLoose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VTight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVLoose, process.rerunDiscriminationByIsolationNewDMMVArun2017v2VVTight, process.rerunDiscriminationByIsolationNewDMMVArun2017v2raw))+cms.Sequence(cms.Task(process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Loose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Medium, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2Tight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VLoose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VTight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVLoose, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2VVTight, process.rerunDiscriminationByIsolationOldDMdR0p3MVArun2017v2raw))+process.deepTau2017v1+process.deepTau2017v2p1)


process.patPFMetTxyCorrSequencePuppiUpdated = cms.Sequence(process.patPFMetTxyCorrPuppiUpdated)


process.patPFMetT2SmearCorrSequencePuppiUpdated = cms.Sequence(process.patSmearedJetsPuppiUpdated+process.selectedPatJetsForMetT1T2SmearCorrPuppiUpdated+process.selectedPatJetsForMetT2SmearCorrPuppiUpdated+process.patPFMetT1T2SmearCorrPuppiUpdated+process.patPFMetT2SmearCorrPuppiUpdated)


process.patPFMetT0CorrSequencePuppiUpdated = cms.Sequence(process.selectedVerticesForPFMEtCorrType0PuppiUpdated+process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0PuppiUpdated+process.particleFlowDisplacedVertex+process.pfCandidateToVertexAssociation+process.patPFMetT0CorrPuppiUpdated)
...
process.patShiftedModuleSequenceModifiedPFMET = cms.Sequence(process.patPFMetT1JetResDownModifiedPFMET+process.patPFMetT1JetResUpModifiedPFMET+process.patPFMetT1MuonEnUpModifiedPFMET+process.patPFMetT1MuonEnDownModifiedPFMET+process.patPFMetT1JetEnUpModifiedPFMET+process.patPFMetT1JetEnDownModifiedPFMET+process.patPFMetT1TauEnUpModifiedPFMET+process.patPFMetT1TauEnDownModifiedPFMET+process.patPFMetT1PhotonEnUpModifiedPFMET+process.patPFMetT1PhotonEnDownModifiedPFMET+process.patPFMetT1ElectronEnUpModifiedPFMET+process.patPFMetT1ElectronEnDownModifiedPFMET+process.patPFMetT1UnclusteredEnUpModifiedPFMET+process.patPFMetT1UnclusteredEnDownModifiedPFMET+process.patPFMetT1SmearModifiedPFMETpatShiftedModuleSequenceModifiedPFMET)


process.patMetCorrectionSequenceModifiedPFMET = cms.Sequence(process.patPFMetT1T2CorrSequenceModifiedPFMET+process.patPFMetT1ModifiedPFMET+process.patPFMetTxyCorrSequenceModifiedPFMET+process.patPFMetT1TxyModifiedPFMET+process.patPFMetTxyModifiedPFMET+process.patPFMetSmearCorrSequenceModifiedPFMET+process.patPFMetT1SmearModifiedPFMET)


process.patMetCorrectionSequencePuppiUpdated = cms.Sequence(process.patPFMetT1T2CorrSequencePuppiUpdated+process.patPFMetT1PuppiUpdated+process.patPFMetTxyCorrSequencePuppiUpdated+process.patPFMetT1TxyPuppiUpdated+process.patPFMetTxyPuppiUpdated+process.patPFMetSmearCorrSequencePuppiUpdated+process.patPFMetT1SmearPuppiUpdated)


process.patMetUncertaintySequencePuppiUpdated = cms.Sequence(process.ak4PFPuppiL1FastL2L3CorrectorChain+process.ak4PFPuppiL1FastL2L3ResidualCorrectorChain+process.shiftedPatJetResDownPuppiUpdated+process.shiftedPatMETCorrJetResDownPuppiUpdated+process.shiftedPatJetResUpPuppiUpdated+process.shiftedPatMETCorrJetResUpPuppiUpdated+process.pfCandsNoJetsPuppiUpdated+process.pfCandsNoJetsNoElePuppiUpdated+process.pfCandsNoJetsNoEleNoMuPuppiUpdated+process.pfCandsNoJetsNoEleNoMuNoTauPuppiUpdated+process.pfCandsForUnclusteredUncPuppiUpdated+process.pfElectronsPuppiUpdated+process.pfTausPuppiUpdated+process.pfMuonsPuppiUpdated+process.pfNoPileUpPuppiUpdated+process.pfPhotonsPuppiUpdated+process.shiftedPatMuonEnDownPuppiUpdated+process.shiftedPatMETCorrMuonEnDownPuppiUpdated+process.shiftedPatMuonEnUpPuppiUpdated+process.shiftedPatMETCorrMuonEnUpPuppiUpdated+process.shiftedPatJetEnDownPuppiUpdated+process.shiftedPatMETCorrJetEnDownPuppiUpdated+process.shiftedPatJetEnUpPuppiUpdated+process.shiftedPatMETCorrJetEnUpPuppiUpdated+process.shiftedPatTauEnDownPuppiUpdated+process.shiftedPatMETCorrTauEnDownPuppiUpdated+process.shiftedPatTauEnUpPuppiUpdated+process.shiftedPatMETCorrTauEnUpPuppiUpdated+process.shiftedPatPhotonEnDownPuppiUpdated+process.shiftedPatMETCorrPhotonEnDownPuppiUpdated+process.shiftedPatPhotonEnUpPuppiUpdated+process.shiftedPatMETCorrPhotonEnUpPuppiUpdated+process.shiftedPatElectronEnDownPuppiUpdated+process.shiftedPatMETCorrElectronEnDownPuppiUpdated+process.shiftedPatElectronEnUpPuppiUpdated+process.shiftedPatMETCorrElectronEnUpPuppiUpdated+process.shiftedPatUnclusteredEnDownPuppiUpdated+process.shiftedPatMETCorrUnclusteredEnDownPuppiUpdated+process.shiftedPatUnclusteredEnUpPuppiUpdated+process.shiftedPatMETCorrUnclusteredEnUpPuppiUpdated+process.patPFMetT1SmearPuppiUpdatedpatMetUncertaintySequencePuppiUpdated)


process.fullPatMetSequenceModifiedPFMET = cms.Sequence(process.patMetModuleSequenceModifiedPFMET+process.patMetCorrectionSequenceModifiedPFMET+process.patMetUncertaintySequenceModifiedPFMET+process.patShiftedModuleSequenceModifiedPFMET+process.patCaloMet+process.slimmedMETsModifiedPFMET)


process.fullPatMetSequencePuppiUpdated = cms.Sequence(process.patMetModuleSequencePuppiUpdated+process.patMetCorrectionSequencePuppiUpdated+process.patMetUncertaintySequencePuppiUpdated+process.patShiftedModuleSequencePuppiUpdated+process.patCaloMet+process.slimmedMETsPuppiUpdated)
...
process.p = cms.Path(process.puppiMETSequence+process.fullPatMetSequencePuppiUpdated+process.fullPatMetSequenceModifiedPFMET+process.egammaPostRecoSeq+process.rerunMvaIsolationSequence+process.slimmedTausNewID+process.prefiringweight+process.ecalBadCalibReducedMINIAODFilter+process.ggNtuplizer)
