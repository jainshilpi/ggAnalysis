...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v4//DYJetsToEEM50LTbinned100To2005fLOTuneCP513TeVmadgraphpythia8RunIISummer19UL17MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v4'

config                                = config()

config.General.requestName = 'DYJetsToEEM50LTbinned100To2005fLOTuneCP513TeVmadgraphpythia8RunIISummer19UL17MiniAODv2106X'
...
config.Data.inputDataset = '/DYJetsToEE_M-50_LTbinned_100To200_5f_LO_TuneCP5_13TeV-madgraph-pythia8/RunIISummer19UL17MiniAODv2-106X_mc2017_realistic_v9-v1/MINIAODSIM'
