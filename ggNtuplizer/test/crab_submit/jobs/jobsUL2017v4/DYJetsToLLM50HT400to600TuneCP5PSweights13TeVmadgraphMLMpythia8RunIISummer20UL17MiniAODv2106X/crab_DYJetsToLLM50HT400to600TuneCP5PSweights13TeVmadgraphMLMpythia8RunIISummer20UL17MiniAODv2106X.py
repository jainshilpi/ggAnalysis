...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v4//DYJetsToLLM50HT400to600TuneCP5PSweights13TeVmadgraphMLMpythia8RunIISummer20UL17MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v4'

config                                = config()

config.General.requestName = 'DYJetsToLLM50HT400to600TuneCP5PSweights13TeVmadgraphMLMpythia8RunIISummer20UL17MiniAODv2106X'
