...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v2Xsecs//GJetsHT100To200TuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv24cores5k106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v2Xsecs'

config                                = config()

config.General.requestName = 'GJetsHT100To200TuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv24cores5k106X'
...
config.Data.inputDataset = '/GJets_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL17MiniAODv2-4cores5k_106X_mc2017_realistic_v9-v1/MINIAODSIM'
