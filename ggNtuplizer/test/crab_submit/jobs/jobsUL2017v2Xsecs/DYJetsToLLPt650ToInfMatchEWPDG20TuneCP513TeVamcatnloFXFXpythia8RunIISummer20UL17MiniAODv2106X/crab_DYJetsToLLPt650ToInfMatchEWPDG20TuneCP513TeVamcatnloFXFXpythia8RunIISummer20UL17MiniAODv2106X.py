...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v2Xsecs//DYJetsToLLPt650ToInfMatchEWPDG20TuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL17MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v2Xsecs'

config                                = config()

config.General.requestName = 'DYJetsToLLPt650ToInfMatchEWPDG20TuneCP513TeVamcatnloFXFXpythia8RunIISummer20UL17MiniAODv2106X'
...
config.Data.inputDataset = '/DYJetsToLL_Pt-650ToInf_MatchEWPDG20_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIISummer20UL17MiniAODv2-106X_mc2017_realistic_v9-v1/MINIAODSIM'
