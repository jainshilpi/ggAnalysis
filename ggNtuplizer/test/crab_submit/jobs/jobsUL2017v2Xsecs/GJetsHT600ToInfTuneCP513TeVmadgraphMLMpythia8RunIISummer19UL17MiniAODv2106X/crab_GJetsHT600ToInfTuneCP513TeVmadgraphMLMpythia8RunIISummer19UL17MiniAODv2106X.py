...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v2Xsecs//GJetsHT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v2Xsecs'

config                                = config()

config.General.requestName = 'GJetsHT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv2106X'
