...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v2Xsecs//GJetsDoubleEMEnrichedPtG40MGG80TuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/jobsUL2017v2Xsecs'

config                                = config()

config.General.requestName = 'GJetsDoubleEMEnrichedPtG40MGG80TuneCP513TeVmadgraphMLMpythia8RunIISummer19UL17MiniAODv2106X'
...
config.Data.inputDataset = '/GJets_DoubleEMEnriched_PtG-40MGG-80_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL17MiniAODv2-106X_mc2017_realistic_v9-v1/MINIAODSIM'
