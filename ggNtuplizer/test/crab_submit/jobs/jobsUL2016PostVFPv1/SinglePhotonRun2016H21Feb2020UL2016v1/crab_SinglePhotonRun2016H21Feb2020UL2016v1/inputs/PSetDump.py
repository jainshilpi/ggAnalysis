...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:2016PreVFPDatTest.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS'),
    globaltag = cms.string('102X_dataRun2_v14'),
...
process.p = cms.Path(process.puppiMETSequence+process.fullPatMetSequencePuppiUpdated+process.fullPatMetSequenceModifiedPFMET+process.egammaPostRecoSeq+process.rerunMvaIsolationSequence+process.slimmedTausNewID+process.ecalBadCalibReducedMINIAODFilter+process.ggNtuplizer)
