...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PostVFPv1//SinglePhotonRun2016G21Feb2020UL2016v1/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016PostVFPv1'

config                                = config()

config.General.requestName = 'SinglePhotonRun2016G21Feb2020UL2016v1'
...
config.JobType.psetName  = '/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/run_data2016PostVFP_106X.py'
...
config.Data.inputDataset = '/SinglePhoton/Run2016G-21Feb2020_UL2016-v1/MINIAOD'
