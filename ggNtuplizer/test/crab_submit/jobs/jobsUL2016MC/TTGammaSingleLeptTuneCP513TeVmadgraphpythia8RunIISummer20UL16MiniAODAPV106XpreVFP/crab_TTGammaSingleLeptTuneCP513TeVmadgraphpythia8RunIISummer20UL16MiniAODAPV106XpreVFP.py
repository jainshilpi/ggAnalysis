...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MC//TTGammaSingleLeptTuneCP513TeVmadgraphpythia8RunIISummer20UL16MiniAODAPV106XpreVFP/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PreVFP/jobsUL2016MC'

config                                = config()

config.General.requestName = 'TTGammaSingleLeptTuneCP513TeVmadgraphpythia8RunIISummer20UL16MiniAODAPV106XpreVFP'
...
config.Data.inputDataset = '/TTGamma_SingleLept_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16MiniAODAPV-106X_mcRun2_asymptotic_preVFP_v8-v2/MINIAODSIM'
