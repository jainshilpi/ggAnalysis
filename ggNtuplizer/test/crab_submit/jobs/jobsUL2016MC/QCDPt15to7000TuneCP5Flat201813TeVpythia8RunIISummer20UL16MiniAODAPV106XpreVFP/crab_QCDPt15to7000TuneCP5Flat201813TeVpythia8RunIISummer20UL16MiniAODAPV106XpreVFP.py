...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MC//QCDPt15to7000TuneCP5Flat201813TeVpythia8RunIISummer20UL16MiniAODAPV106XpreVFP/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PreVFP/jobsUL2016MC'

config                                = config()

config.General.requestName = 'QCDPt15to7000TuneCP5Flat201813TeVpythia8RunIISummer20UL16MiniAODAPV106XpreVFP'
...
config.Data.inputDataset = '/QCD_Pt-15to7000_TuneCP5_Flat2018_13TeV_pythia8/RunIISummer20UL16MiniAODAPV-106X_mcRun2_asymptotic_preVFP_v8-v2/MINIAODSIM'
