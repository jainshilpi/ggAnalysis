...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MC//TTGammaDileptTuneCP513TeVmadgraphpythia8RunIISummer20UL16MiniAODAPVv2106XpreVFP/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PreVFP/jobsUL2016MC'

config                                = config()

config.General.requestName = 'TTGammaDileptTuneCP513TeVmadgraphpythia8RunIISummer20UL16MiniAODAPVv2106XpreVFP'
