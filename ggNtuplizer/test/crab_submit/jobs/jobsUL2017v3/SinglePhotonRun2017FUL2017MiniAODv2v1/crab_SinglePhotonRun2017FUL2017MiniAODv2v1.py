...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v3//SinglePhotonRun2017FUL2017MiniAODv2v1/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v3'

config                                = config()

config.General.requestName = 'SinglePhotonRun2017FUL2017MiniAODv2v1'
...
config.Data.inputDataset = '/SinglePhoton/Run2017F-UL2017_MiniAODv2-v1/MINIAOD'
