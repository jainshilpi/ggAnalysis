...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/hep.wisc.edu/user/wadud/private/signal_production/CMSSW_10_6_29/src/genproductions/bin/MadGraph5_aMCatNLO/ZNuNuGproduction/aNTGC_ZNuNuG_MINIAODSIM.root')
)
...
process.patJetFlavourAssociationPuppi = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartonsPuppi","bHadrons"),
    cHadrons = cms.InputTag("patJetPartonsPuppi","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak4PFJetsPuppi"),
    leptons = cms.InputTag("patJetPartonsPuppi","leptons"),
    partons = cms.InputTag("patJetPartonsPuppi","physicsPartons"),
    rParam = cms.double(0.4)
)
...
process.patJetPartonsLegacyPuppi = cms.EDProducer("PartonSelector",
    src = cms.InputTag("genParticles"),
    withLeptons = cms.bool(False)
)
...
process.patJetPartonsPuppi = cms.EDProducer("HadronAndPartonSelector",
    fullChainPhysPartons = cms.bool(True),
    particles = cms.InputTag("genParticles"),
    partonMode = cms.string('Auto'),
    src = cms.InputTag("generator")
...
process.patAlgosToolsTask = cms.Task(*[process.AK4PFCHSupdatedpileupJetIdCalculator, process.AK4PFCHSupdatedpileupJetIdEvaluator, process.QGTaggerAK4PFCHSupdated, process.ak4CaloL2L3CorrectorModifiedPFMET, process.ak4CaloL2L3CorrectorPuppi, process.ak4CaloL2L3ResidualCorrectorModifiedPFMET, process.ak4CaloL2L3ResidualCorrectorPuppi, process.ak4CaloL2RelativeCorrectorModifiedPFMET, process.ak4CaloL2RelativeCorrectorPuppi, process.ak4CaloL3AbsoluteCorrectorModifiedPFMET, process.ak4CaloL3AbsoluteCorrectorPuppi, process.ak4CaloResidualCorrectorModifiedPFMET, process.ak4CaloResidualCorrectorPuppi, process.ak4GenJetsNoNu, process.ak4PFCHSL1FastL2L3CorrectorModifiedPFMET, process.ak4PFCHSL1FastL2L3CorrectorPuppi, process.ak4PFCHSL1FastL2L3ResidualCorrectorModifiedPFMET, process.ak4PFCHSL1FastL2L3ResidualCorrectorPuppi, process.ak4PFCHSL1FastjetCorrectorModifiedPFMET, process.ak4PFCHSL1FastjetCorrectorPuppi, process.ak4PFCHSL2RelativeCorrectorModifiedPFMET, process.ak4PFCHSL2RelativeCorrectorPuppi, process.ak4PFCHSL3AbsoluteCorrectorModifiedPFMET, process.ak4PFCHSL3AbsoluteCorrectorPuppi, process.ak4PFCHSResidualCorrectorModifiedPFMET, process.ak4PFCHSResidualCorrectorPuppi, process.ak4PFJetsCHSModifiedPFMET, process.ak4PFJetsCHSupdated, process.ak4PFJetsCHSupdatedConstituents, process.ak4PFJetsPuppi, process.ak4PFJetsPuppiupdated, process.ak4PFJetsPuppiupdatedConstituents, process.basicJetsForMetModifiedPFMET, process.basicJetsForMetPuppi, process.caloMetT1ModifiedPFMET, process.caloMetT1Puppi, process.caloMetT1T2ModifiedPFMET, process.caloMetT1T2Puppi, process.chs, process.cleanedPatJetsModifiedPFMET, process.cleanedPatJetsPuppi, process.corrCaloMetType1ModifiedPFMET, process.corrCaloMetType1Puppi, process.corrCaloMetType2ModifiedPFMET, process.corrCaloMetType2Puppi, process.corrPfMetType1ModifiedPFMET, process.corrPfMetType1Puppi, process.corrPfMetType2ModifiedPFMET, process.corrPfMetType2Puppi, process.genMetExtractorModifiedPFMET, process.genMetExtractorPuppi, process.jetCorrectorsTask, process.jetSelectorForMetModifiedPFMET, process.jetSelectorForMetPuppi, process.makePatMETsTask, process.metrawCaloModifiedPFMET, process.metrawCaloPuppi, process.muCaloMetCorrModifiedPFMET, process.muCaloMetCorrPuppi, process.packedGenParticlesForJetsNoNu, process.particleFlowPtrsModifiedPFMET, process.particleFlowPtrsPuppi, process.patCHSMet, process.patCaloMet, process.patJetCorrFactorsAK4PFCHSupdated, process.patJetCorrFactorsAK4PFPuppiupdated, process.patJetCorrFactorsModifiedPFMET, process.patJetCorrFactorsPuppi, process.patJetFlavourAssociationAK4PFCHSupdated, process.patJetFlavourAssociationAK4PFPuppiupdated, process.patJetFlavourAssociationLegacyAK4PFCHSupdated, process.patJetFlavourAssociationLegacyAK4PFPuppiupdated, process.patJetFlavourAssociationLegacyModifiedPFMET, process.patJetFlavourAssociationLegacyPuppi, process.patJetFlavourAssociationModifiedPFMET, process.patJetFlavourAssociationPuppi, process.patJetGenJetMatchAK4PFCHSupdated, process.patJetGenJetMatchAK4PFPuppiupdated, process.patJetGenJetMatchModifiedPFMET, process.patJetGenJetMatchPuppi, process.patJetPartonAssociationLegacyAK4PFCHSupdated, process.patJetPartonAssociationLegacyAK4PFPuppiupdated, process.patJetPartonAssociationLegacyModifiedPFMET, process.patJetPartonAssociationLegacyPuppi, process.patJetPartonMatchAK4PFCHSupdated, process.patJetPartonMatchAK4PFPuppiupdated, process.patJetPartonMatchModifiedPFMET, process.patJetPartonMatchPuppi, process.patJetPartonsLegacyModifiedPFMET, process.patJetPartonsLegacyPuppi, process.patJetPartonsLegacyupdated, process.patJetPartonsModifiedPFMET, process.patJetPartonsPuppi, process.patJetPartonsupdated, process.patJetsAK4PFCHSupdated, process.patJetsAK4PFCHSupdatedPATJetswithUserData, process.patJetsAK4PFCHSupdatedlooseJetId, process.patJetsAK4PFCHSupdatedtightJetId, process.patJetsAK4PFCHSupdatedtightJetIdLepVeto, process.patJetsAK4PFPuppiupdated, process.patJetsAK4PFPuppiupdatedPATJetswithUserData, process.patJetsAK4PFPuppiupdatedlooseJetId, process.patJetsAK4PFPuppiupdatedtightJetId, process.patJetsAK4PFPuppiupdatedtightJetIdLepVeto, process.patJetsModifiedPFMET, process.patJetsPuppi, process.patPFMetModifiedPFMET, process.patPFMetPuppi, process.patPFMetT0CorrModifiedPFMET, process.patPFMetT0CorrPuppi, process.patPFMetT0pcT1ModifiedPFMET, process.patPFMetT0pcT1Puppi, process.patPFMetT0pcT1T2ModifiedPFMET, process.patPFMetT0pcT1T2Puppi, process.patPFMetT1ElectronEnDownModifiedPFMET, process.patPFMetT1ElectronEnDownPuppi, process.patPFMetT1ElectronEnUpModifiedPFMET, process.patPFMetT1ElectronEnUpPuppi, process.patPFMetT1JetEnDownModifiedPFMET, process.patPFMetT1JetEnDownPuppi, process.patPFMetT1JetEnUpModifiedPFMET, process.patPFMetT1JetEnUpPuppi, process.patPFMetT1JetResDownModifiedPFMET, process.patPFMetT1JetResDownPuppi, process.patPFMetT1JetResUpModifiedPFMET, process.patPFMetT1JetResUpPuppi, process.patPFMetT1ModifiedPFMET, process.patPFMetT1MuonEnDownModifiedPFMET, process.patPFMetT1MuonEnDownPuppi, process.patPFMetT1MuonEnUpModifiedPFMET, process.patPFMetT1MuonEnUpPuppi, process.patPFMetT1PhotonEnDownModifiedPFMET, process.patPFMetT1PhotonEnDownPuppi, process.patPFMetT1PhotonEnUpModifiedPFMET, process.patPFMetT1PhotonEnUpPuppi, process.patPFMetT1Puppi, process.patPFMetT1SmearElectronEnDownModifiedPFMET, process.patPFMetT1SmearElectronEnDownPuppi, process.patPFMetT1SmearElectronEnUpModifiedPFMET, process.patPFMetT1SmearElectronEnUpPuppi, process.patPFMetT1SmearJetEnDownModifiedPFMET, process.patPFMetT1SmearJetEnDownPuppi, process.patPFMetT1SmearJetEnUpModifiedPFMET, process.patPFMetT1SmearJetEnUpPuppi, process.patPFMetT1SmearJetResDownModifiedPFMET, process.patPFMetT1SmearJetResDownPuppi, process.patPFMetT1SmearJetResUpModifiedPFMET, process.patPFMetT1SmearJetResUpPuppi, process.patPFMetT1SmearModifiedPFMET, process.patPFMetT1SmearMuonEnDownModifiedPFMET, process.patPFMetT1SmearMuonEnDownPuppi, process.patPFMetT1SmearMuonEnUpModifiedPFMET, process.patPFMetT1SmearMuonEnUpPuppi, process.patPFMetT1SmearPhotonEnDownModifiedPFMET, process.patPFMetT1SmearPhotonEnDownPuppi, process.patPFMetT1SmearPhotonEnUpModifiedPFMET, process.patPFMetT1SmearPhotonEnUpPuppi, process.patPFMetT1SmearPuppi, process.patPFMetT1SmearTauEnDownModifiedPFMET, process.patPFMetT1SmearTauEnDownPuppi, process.patPFMetT1SmearTauEnUpModifiedPFMET, process.patPFMetT1SmearTauEnUpPuppi, process.patPFMetT1SmearUnclusteredEnDownModifiedPFMET, process.patPFMetT1SmearUnclusteredEnDownPuppi, process.patPFMetT1SmearUnclusteredEnUpModifiedPFMET, process.patPFMetT1SmearUnclusteredEnUpPuppi, process.patPFMetT1T2CorrModifiedPFMET, process.patPFMetT1T2CorrPuppi, process.patPFMetT1T2ModifiedPFMET, process.patPFMetT1T2Puppi, process.patPFMetT1T2SmearCorrModifiedPFMET, process.patPFMetT1T2SmearCorrPuppi, process.patPFMetT1TauEnDownModifiedPFMET, process.patPFMetT1TauEnDownPuppi, process.patPFMetT1TauEnUpModifiedPFMET, process.patPFMetT1TauEnUpPuppi, process.patPFMetT1TxyModifiedPFMET, process.patPFMetT1TxyPuppi, process.patPFMetT1UnclusteredEnDownModifiedPFMET, process.patPFMetT1UnclusteredEnDownPuppi, process.patPFMetT1UnclusteredEnUpModifiedPFMET, process.patPFMetT1UnclusteredEnUpPuppi, process.patPFMetT2CorrModifiedPFMET, process.patPFMetT2CorrPuppi, process.patPFMetT2SmearCorrModifiedPFMET, process.patPFMetT2SmearCorrPuppi, process.patPFMetT2SmearCorrTask, process.patPFMetTxyCorrModifiedPFMET, process.patPFMetTxyCorrPuppi, process.patPFMetTxyCorrTask, process.patPFMetTxyModifiedPFMET, process.patPFMetTxyPuppi, process.patSmearedJetsModifiedPFMET, process.patSmearedJetsPuppi, process.patTrkMet, process.pfCHS, process.pfCandMETcorrModifiedPFMET, process.pfCandMETcorrPuppi, process.pfCandsForUnclusteredUncModifiedPFMET, process.pfCandsForUnclusteredUncPuppi, process.pfCandsNoJetsModifiedPFMET, process.pfCandsNoJetsNoEleModifiedPFMET, process.pfCandsNoJetsNoEleNoMuModifiedPFMET, process.pfCandsNoJetsNoEleNoMuNoTauModifiedPFMET, process.pfCandsNoJetsNoEleNoMuNoTauPuppi, process.pfCandsNoJetsNoEleNoMuPuppi, process.pfCandsNoJetsNoElePuppi, process.pfCandsNoJetsPuppi, process.pfCandsNotInJetsForMetCorrModifiedPFMET, process.pfCandsNotInJetsForMetCorrPuppi, process.pfCandsNotInJetsPtrForMetCorrModifiedPFMET, process.pfCandsNotInJetsPtrForMetCorrPuppi, process.pfElectronsModifiedPFMET, process.pfElectronsPuppi, process.pfJetsPtrForMetCorrModifiedPFMET, process.pfJetsPtrForMetCorrPuppi, process.pfLeptonsPUPPET, process.pfMetCHS, process.pfMetModifiedPFMET, process.pfMetPuppi, process.pfMetT1ModifiedPFMET, process.pfMetT1Puppi, process.pfMetT1T2ModifiedPFMET, process.pfMetT1T2Puppi, process.pfMetTrk, process.pfMuonsModifiedPFMET, process.pfMuonsPuppi, process.pfNoLepPUPPI, process.pfNoPileUpJMEModifiedPFMET, process.pfNoPileUpModifiedPFMET, process.pfNoPileUpPuppi, process.pfPhotonsModifiedPFMET, process.pfPhotonsPuppi, process.pfTausModifiedPFMET, process.pfTausPuppi, process.pfTrk, process.producePatPFMETCorrectionsTask, process.puppi, process.puppiForMET, process.puppiMerged, process.puppiNoLep, process.puppiPhoton, process.selectedPatJetsAK4PFCHSupdated, process.selectedPatJetsAK4PFPuppiupdated, process.selectedPatJetsForMetT1T2CorrModifiedPFMET, process.selectedPatJetsForMetT1T2CorrPuppi, process.selectedPatJetsForMetT1T2SmearCorrModifiedPFMET, process.selectedPatJetsForMetT1T2SmearCorrPuppi, process.selectedPatJetsForMetT2CorrModifiedPFMET, process.selectedPatJetsForMetT2CorrPuppi, process.selectedPatJetsForMetT2SmearCorrModifiedPFMET, process.selectedPatJetsForMetT2SmearCorrPuppi, process.selectedPatJetsModifiedPFMET, process.selectedPatJetsPuppi, process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0ModifiedPFMET, process.selectedPrimaryVertexHighestPtTrackSumForPFMEtCorrType0Puppi, process.selectedVerticesForPFMEtCorrType0ModifiedPFMET, process.selectedVerticesForPFMEtCorrType0Puppi, process.shiftedPatElectronEnDownModifiedPFMET, process.shiftedPatElectronEnDownPuppi, process.shiftedPatElectronEnUpModifiedPFMET, process.shiftedPatElectronEnUpPuppi, process.shiftedPatJetEnDownModifiedPFMET, process.shiftedPatJetEnDownPuppi, process.shiftedPatJetEnUpModifiedPFMET, process.shiftedPatJetEnUpPuppi, process.shiftedPatJetResDownModifiedPFMET, process.shiftedPatJetResDownPuppi, process.shiftedPatJetResUpModifiedPFMET, process.shiftedPatJetResUpPuppi, process.shiftedPatMETCorrElectronEnDownModifiedPFMET, process.shiftedPatMETCorrElectronEnDownPuppi, process.shiftedPatMETCorrElectronEnUpModifiedPFMET, process.shiftedPatMETCorrElectronEnUpPuppi, process.shiftedPatMETCorrJetEnDownModifiedPFMET, process.shiftedPatMETCorrJetEnDownPuppi, process.shiftedPatMETCorrJetEnUpModifiedPFMET, process.shiftedPatMETCorrJetEnUpPuppi, process.shiftedPatMETCorrJetResDownModifiedPFMET, process.shiftedPatMETCorrJetResDownPuppi, process.shiftedPatMETCorrJetResUpModifiedPFMET, process.shiftedPatMETCorrJetResUpPuppi, process.shiftedPatMETCorrMuonEnDownModifiedPFMET, process.shiftedPatMETCorrMuonEnDownPuppi, process.shiftedPatMETCorrMuonEnUpModifiedPFMET, process.shiftedPatMETCorrMuonEnUpPuppi, process.shiftedPatMETCorrPhotonEnDownModifiedPFMET, process.shiftedPatMETCorrPhotonEnDownPuppi, process.shiftedPatMETCorrPhotonEnUpModifiedPFMET, process.shiftedPatMETCorrPhotonEnUpPuppi, process.shiftedPatMETCorrSmearedJetResDownModifiedPFMET, process.shiftedPatMETCorrSmearedJetResDownPuppi, process.shiftedPatMETCorrSmearedJetResUpModifiedPFMET, process.shiftedPatMETCorrSmearedJetResUpPuppi, process.shiftedPatMETCorrTauEnDownModifiedPFMET, process.shiftedPatMETCorrTauEnDownPuppi, process.shiftedPatMETCorrTauEnUpModifiedPFMET, process.shiftedPatMETCorrTauEnUpPuppi, process.shiftedPatMETCorrUnclusteredEnDownModifiedPFMET, process.shiftedPatMETCorrUnclusteredEnDownPuppi, process.shiftedPatMETCorrUnclusteredEnUpModifiedPFMET, process.shiftedPatMETCorrUnclusteredEnUpPuppi, process.shiftedPatMuonEnDownModifiedPFMET, process.shiftedPatMuonEnDownPuppi, process.shiftedPatMuonEnUpModifiedPFMET, process.shiftedPatMuonEnUpPuppi, process.shiftedPatPhotonEnDownModifiedPFMET, process.shiftedPatPhotonEnDownPuppi, process.shiftedPatPhotonEnUpModifiedPFMET, process.shiftedPatPhotonEnUpPuppi, process.shiftedPatSmearedJetResDownModifiedPFMET, process.shiftedPatSmearedJetResDownPuppi, process.shiftedPatSmearedJetResUpModifiedPFMET, process.shiftedPatSmearedJetResUpPuppi, process.shiftedPatTauEnDownModifiedPFMET, process.shiftedPatTauEnDownPuppi, process.shiftedPatTauEnUpModifiedPFMET, process.shiftedPatTauEnUpPuppi, process.shiftedPatUnclusteredEnDownModifiedPFMET, process.shiftedPatUnclusteredEnDownPuppi, process.shiftedPatUnclusteredEnUpModifiedPFMET, process.shiftedPatUnclusteredEnUpPuppi, process.slimmedMETsModifiedPFMET, process.slimmedMETsPuppi])
...
process.patMetModuleSequencePuppi = cms.Sequence(process.pfMetPuppi+process.ak4PFJetsPuppi+process.patJetCorrFactorsPuppi+process.patJetsPuppi+process.basicJetsForMetPuppi+process.jetSelectorForMetPuppi+process.cleanedPatJetsPuppi+process.metrawCaloPuppi+process.genMetExtractorPuppi+process.pfCHS+process.pfMetCHS+process.patCHSMet+process.pfTrk+process.pfMetTrk+process.patTrkMet+process.patPFMetPuppi)
...
process.p = cms.Path(process.puppiMETSequence+process.fullPatMetSequencePuppi+process.fullPatMetSequenceModifiedPFMET+process.egammaPostRecoSeq+process.rerunMvaIsolationSequence+process.slimmedTausNewID+process.prefiringweight+process.ecalBadCalibReducedMINIAODFilter+process.ggNtuplizer)
