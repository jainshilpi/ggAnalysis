...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v3//aNTGCZNuNuGamma6002017/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v3'

config                                = config()

config.General.requestName = 'aNTGCZNuNuGamma6002017'
...
config.Data.inputDataset = '/aNTGC_ZNuNuGamma_600_2017/mwadud-aNTGC_ZNuNuGamma_600_2017_MINIAODSIM-9e917789915949e1459afa5cbef42bd5/USER'
