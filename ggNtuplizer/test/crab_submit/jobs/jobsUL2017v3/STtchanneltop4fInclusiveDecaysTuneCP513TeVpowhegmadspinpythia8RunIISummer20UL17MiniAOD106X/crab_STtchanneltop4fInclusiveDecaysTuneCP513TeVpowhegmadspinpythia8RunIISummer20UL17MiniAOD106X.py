...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2017v3//STtchanneltop4fInclusiveDecaysTuneCP513TeVpowhegmadspinpythia8RunIISummer20UL17MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2017/jobsUL2017v3'

config                                = config()

config.General.requestName = 'STtchanneltop4fInclusiveDecaysTuneCP513TeVpowhegmadspinpythia8RunIISummer20UL17MiniAOD106X'
...
config.Data.inputDataset = '/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/RunIISummer20UL17MiniAOD-106X_mc2017_realistic_v6-v1/MINIAODSIM'
