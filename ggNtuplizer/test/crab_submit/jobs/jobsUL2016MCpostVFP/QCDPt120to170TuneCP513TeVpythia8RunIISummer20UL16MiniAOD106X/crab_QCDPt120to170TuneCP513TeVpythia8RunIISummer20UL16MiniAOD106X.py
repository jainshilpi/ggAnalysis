...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MCpostVFP//QCDPt120to170TuneCP513TeVpythia8RunIISummer20UL16MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016MCpostVFP'

config                                = config()

config.General.requestName = 'QCDPt120to170TuneCP513TeVpythia8RunIISummer20UL16MiniAOD106X'
...
config.Data.inputDataset = '/QCD_Pt_120to170_TuneCP5_13TeV_pythia8/RunIISummer20UL16MiniAOD-106X_mcRun2_asymptotic_v13-v2/MINIAODSIM'
