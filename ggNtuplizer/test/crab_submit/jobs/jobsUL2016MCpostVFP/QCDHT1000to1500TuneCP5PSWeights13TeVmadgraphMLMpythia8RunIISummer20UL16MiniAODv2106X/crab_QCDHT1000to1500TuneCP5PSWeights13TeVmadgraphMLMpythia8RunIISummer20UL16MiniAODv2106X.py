...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MCpostVFP//QCDHT1000to1500TuneCP5PSWeights13TeVmadgraphMLMpythia8RunIISummer20UL16MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016MCpostVFP'

config                                = config()

config.General.requestName = 'QCDHT1000to1500TuneCP5PSWeights13TeVmadgraphMLMpythia8RunIISummer20UL16MiniAODv2106X'
