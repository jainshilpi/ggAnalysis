...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MCpostVFP//WWW4FTuneCP513TeVamcatnlopythia8RunIISummer20UL16MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016MCpostVFP'

config                                = config()

config.General.requestName = 'WWW4FTuneCP513TeVamcatnlopythia8RunIISummer20UL16MiniAOD106X'
...
config.Data.inputDataset = '/WWW_4F_TuneCP5_13TeV-amcatnlo-pythia8/RunIISummer20UL16MiniAOD-106X_mcRun2_asymptotic_v13_ext1-v2/MINIAODSIM'
