...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MCpostVFP//GJetPt15To6000TuneCP5Flat13TeVpythia8RunIISummer19UL16MiniAOD106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016MCpostVFP'

config                                = config()

config.General.requestName = 'GJetPt15To6000TuneCP5Flat13TeVpythia8RunIISummer19UL16MiniAOD106X'
...
config.Data.inputDataset = '/GJet_Pt-15To6000_TuneCP5-Flat_13TeV_pythia8/RunIISummer19UL16MiniAOD-106X_mcRun2_asymptotic_v13-v2/MINIAODSIM'
