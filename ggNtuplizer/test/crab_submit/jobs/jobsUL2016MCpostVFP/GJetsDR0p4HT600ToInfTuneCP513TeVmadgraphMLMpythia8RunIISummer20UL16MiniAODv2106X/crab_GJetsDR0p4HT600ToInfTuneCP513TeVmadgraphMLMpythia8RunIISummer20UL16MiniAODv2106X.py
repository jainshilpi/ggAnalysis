...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016MCpostVFP//GJetsDR0p4HT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer20UL16MiniAODv2106X/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PostVFP/jobsUL2016MCpostVFP'

config                                = config()

config.General.requestName = 'GJetsDR0p4HT600ToInfTuneCP513TeVmadgraphMLMpythia8RunIISummer20UL16MiniAODv2106X'
...
config.Data.inputDataset = '/GJets_DR-0p4_HT-600ToInf_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer20UL16MiniAODv2-106X_mcRun2_asymptotic_v17-v2/MINIAODSIM'
