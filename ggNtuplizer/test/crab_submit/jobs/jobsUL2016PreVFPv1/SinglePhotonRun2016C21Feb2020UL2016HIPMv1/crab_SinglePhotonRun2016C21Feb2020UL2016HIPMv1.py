...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2016PreVFPv1//SinglePhotonRun2016C21Feb2020UL2016HIPMv1/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2016PreVFP/jobsUL2016PreVFPv1'

config                                = config()

config.General.requestName = 'SinglePhotonRun2016C21Feb2020UL2016HIPMv1'
...
config.Data.inputDataset = '/SinglePhoton/Run2016C-21Feb2020_UL2016_HIPM-v1/MINIAOD'
