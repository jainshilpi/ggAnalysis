...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:2018DatTest.root')
)
...
process.p = cms.Path(process.triggerSelection+process.puppiMETSequence+process.fullPatMetSequencePuppiUpdated+process.fullPatMetSequenceModifiedPFMET+process.egammaPostRecoSeq+process.rerunMvaIsolationSequence+process.slimmedTausNewID+process.ecalBadCalibReducedMINIAODFilter+process.ggNtuplizer)
