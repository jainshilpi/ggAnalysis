...
workarea='/afs/hep.wisc.edu/user/wadud/private/CMSSW_10_6_24/src/ggAnalysis/ggNtuplizer/test/crab_submit//jobs//jobsUL2018AtoC//EGammaRun2018C12Nov2019UL2018v2/'

mainOutputDir = '/store/user/mwadud/aNTGCmet/ntuples/UL2018AtoC/jobsUL2018AtoC'

config                                = config()

config.General.requestName = 'EGammaRun2018C12Nov2019UL2018v2'
